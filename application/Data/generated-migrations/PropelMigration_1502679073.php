 ...
 * up to version 1502679073.
 * Generated on 2017-08-14 02:51:13 by marvin
 */
class PropelMigration_1502679073
{
    public $comment = '';
...
ALTER TABLE `tf_items_related_users` ADD CONSTRAINT `tf_items_related_users_fk_b49f13`
    FOREIGN KEY (`item_id`)
...
ALTER TABLE `tf_items_related_users` DROP FOREIGN KEY `tf_items_related_users_fk_b49f13`;
