...
use TheFarm\Models\Facilities;
use TheFarm\Models\FacilitiesQuery;
...
class FacilitiesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.FacilitiesTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Facilities';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Facilities';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FacilitiesTableMap::COL_FACILITY_ID, FacilitiesTableMap::COL_FACILITY_NAME, FacilitiesTableMap::COL_BG_COLOR, FacilitiesTableMap::COL_MAX_ACCOMODATION, FacilitiesTableMap::COL_LOCATION_ID, FacilitiesTableMap::COL_ABBR, FacilitiesTableMap::COL_STATUS, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FacilitiesTableMap::COL_FACILITY_ID => 0, FacilitiesTableMap::COL_FACILITY_NAME => 1, FacilitiesTableMap::COL_BG_COLOR => 2, FacilitiesTableMap::COL_MAX_ACCOMODATION => 3, FacilitiesTableMap::COL_LOCATION_ID => 4, FacilitiesTableMap::COL_ABBR => 5, FacilitiesTableMap::COL_STATUS => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Facilities');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FacilitiesTableMap::COL_FACILITY_ID);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_FACILITY_NAME);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_BG_COLOR);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_MAX_ACCOMODATION);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_LOCATION_ID);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_ABBR);
            $criteria->addSelectColumn(FacilitiesTableMap::COL_STATUS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Facilities) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(FacilitiesTableMap::DATABASE_NAME);
            $criteria->add(FacilitiesTableMap::COL_FACILITY_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(FacilitiesTableMap::COL_FACILITY_ID) && $criteria->keyContainsValue(FacilitiesTableMap::COL_FACILITY_ID) ) {
