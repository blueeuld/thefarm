...
use TheFarm\Models\Locations;
use TheFarm\Models\LocationsQuery;


/**
 * This class defines the structure of the 'tf_locations' table.
 *
 *
 *
...
class LocationsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.LocationsTableMap';
     ...
     */
    const TABLE_NAME = 'tf_locations';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\TheFarm\\Models\\Locations';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Locations';
     ...
     */
    const COL_LOCATION_ID = 'tf_locations.location_id';

    /**
     * the column name for the location field
     */
    const COL_LOCATION = 'tf_locations.location';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('LocationId', 'Location', ),
        self::TYPE_CAMELNAME     => array('locationId', 'location', ),
        self::TYPE_COLNAME       => array(LocationsTableMap::COL_LOCATION_ID, LocationsTableMap::COL_LOCATION, ),
        self::TYPE_FIELDNAME     => array('location_id', 'location', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('LocationId' => 0, 'Location' => 1, ),
        self::TYPE_CAMELNAME     => array('locationId' => 0, 'location' => 1, ),
        self::TYPE_COLNAME       => array(LocationsTableMap::COL_LOCATION_ID => 0, LocationsTableMap::COL_LOCATION => 1, ),
        self::TYPE_FIELDNAME     => array('location_id' => 0, 'location' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('tf_locations');
        $this->setPhpName('Locations');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\TheFarm\\Models\\Locations');
  ...
  array (
    ...
    1 => ':location_id',
        ...
        $this->addRelation('Facilities', '\\TheFarm\\Models\\Facilities', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':location_id',
    1 => ':location_id',
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LocationsTableMap::COL_LOCATION_ID);
            $criteria->addSelectColumn(LocationsTableMap::COL_LOCATION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Locations) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(LocationsTableMap::DATABASE_NAME);
            $criteria->add(LocationsTableMap::COL_LOCATION_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(LocationsTableMap::COL_LOCATION_ID) && $criteria->keyContainsValue(LocationsTableMap::COL_LOCATION_ID) ) {
