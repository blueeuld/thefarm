...
use TheFarm\Models\Items;
use TheFarm\Models\ItemsQuery;
...
class ItemsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.ItemsTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Items';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Items';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ItemsTableMap::COL_ITEM_ID, ItemsTableMap::COL_TITLE, ItemsTableMap::COL_DESCRIPTION, ItemsTableMap::COL_DURATION, ItemsTableMap::COL_AMOUNT, ItemsTableMap::COL_UOM, ItemsTableMap::COL_ABBR, ItemsTableMap::COL_MAX_PROVIDER, ItemsTableMap::COL_FOR_SALE, ItemsTableMap::COL_ITEM_IMAGE, ItemsTableMap::COL_BOOKABLE, ItemsTableMap::COL_TIME_SETTINGS, ItemsTableMap::COL_IS_ACTIVE, ItemsTableMap::COL_ITEM_ICON, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ItemsTableMap::COL_ITEM_ID => 0, ItemsTableMap::COL_TITLE => 1, ItemsTableMap::COL_DESCRIPTION => 2, ItemsTableMap::COL_DURATION => 3, ItemsTableMap::COL_AMOUNT => 4, ItemsTableMap::COL_UOM => 5, ItemsTableMap::COL_ABBR => 6, ItemsTableMap::COL_MAX_PROVIDER => 7, ItemsTableMap::COL_FOR_SALE => 8, ItemsTableMap::COL_ITEM_IMAGE => 9, ItemsTableMap::COL_BOOKABLE => 10, ItemsTableMap::COL_TIME_SETTINGS => 11, ItemsTableMap::COL_IS_ACTIVE => 12, ItemsTableMap::COL_ITEM_ICON => 13, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Items');
  ...
  array (
    ...
    1 => ':item_id',
        ...
        $this->addRelation('ItemCategories', '\\TheFarm\\Models\\ItemCategories', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':item_id',
    1 => ':item_id',
  ),
), null, null, 'ItemCategoriess', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ItemsTableMap::COL_TITLE);
            $criteria->addSelectColumn(ItemsTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ItemsTableMap::COL_DURATION);
            $criteria->addSelectColumn(ItemsTableMap::COL_AMOUNT);
            $criteria->addSelectColumn(ItemsTableMap::COL_UOM);
            $criteria->addSelectColumn(ItemsTableMap::COL_ABBR);
            $criteria->addSelectColumn(ItemsTableMap::COL_MAX_PROVIDER);
            $criteria->addSelectColumn(ItemsTableMap::COL_FOR_SALE);
            $criteria->addSelectColumn(ItemsTableMap::COL_ITEM_IMAGE);
            $criteria->addSelectColumn(ItemsTableMap::COL_BOOKABLE);
            $criteria->addSelectColumn(ItemsTableMap::COL_TIME_SETTINGS);
            $criteria->addSelectColumn(ItemsTableMap::COL_IS_ACTIVE);
            $criteria->addSelectColumn(ItemsTableMap::COL_ITEM_ICON);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Items) { // it's a model object
