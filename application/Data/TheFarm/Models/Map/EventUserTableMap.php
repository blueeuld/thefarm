...
use TheFarm\Models\EventUser;
use TheFarm\Models\EventUserQuery;
...
class EventUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.EventUserTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\EventUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.EventUser';
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \TheFarm\Models\EventUser $obj A \TheFarm\Models\EventUser object.
     ...
     *
     * @param mixed $value A \TheFarm\Models\EventUser object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \TheFarm\Models\EventUser) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \TheFarm\Models\EventUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\EventUser) { // it's a model object
