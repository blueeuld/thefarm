...
use TheFarm\Models\Package;
use TheFarm\Models\PackageQuery;
...
class PackageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.PackageTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Package';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Package';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PackageTableMap::COL_PACKAGE_ID, PackageTableMap::COL_PACKAGE_NAME, PackageTableMap::COL_PACKAGE_TYPE, PackageTableMap::COL_DURATION, PackageTableMap::COL_PACKAGE_TYPE_ID, PackageTableMap::COL_PERSONALIZED, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PackageTableMap::COL_PACKAGE_ID => 0, PackageTableMap::COL_PACKAGE_NAME => 1, PackageTableMap::COL_PACKAGE_TYPE => 2, PackageTableMap::COL_DURATION => 3, PackageTableMap::COL_PACKAGE_TYPE_ID => 4, PackageTableMap::COL_PERSONALIZED => 5, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Package');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PackageTableMap::COL_PACKAGE_NAME);
            $criteria->addSelectColumn(PackageTableMap::COL_PACKAGE_TYPE);
            $criteria->addSelectColumn(PackageTableMap::COL_DURATION);
            $criteria->addSelectColumn(PackageTableMap::COL_PACKAGE_TYPE_ID);
            $criteria->addSelectColumn(PackageTableMap::COL_PERSONALIZED);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Package) { // it's a model object
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PackageTableMap::COL_PACKAGE_ID) && $criteria->keyContainsValue(PackageTableMap::COL_PACKAGE_ID) ) {
