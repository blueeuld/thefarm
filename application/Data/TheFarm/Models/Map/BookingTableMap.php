...
class BookingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.BookingTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Booking';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Booking';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(BookingTableMap::COL_BOOKING_ID, BookingTableMap::COL_TITLE, BookingTableMap::COL_PACKAGE_ID, BookingTableMap::COL_START_DATE, BookingTableMap::COL_END_DATE, BookingTableMap::COL_NOTES, BookingTableMap::COL_STATUS, BookingTableMap::COL_GUEST_ID, BookingTableMap::COL_FAX, BookingTableMap::COL_AUTHOR_ID, BookingTableMap::COL_ENTRY_DATE, BookingTableMap::COL_EDIT_DATE, BookingTableMap::COL_PERSONALIZED, BookingTableMap::COL_ROOM_ID, BookingTableMap::COL_RESTRICTIONS, BookingTableMap::COL_PACKAGE_TYPE_ID, BookingTableMap::COL_IS_ACTIVE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(BookingTableMap::COL_BOOKING_ID => 0, BookingTableMap::COL_TITLE => 1, BookingTableMap::COL_PACKAGE_ID => 2, BookingTableMap::COL_START_DATE => 3, BookingTableMap::COL_END_DATE => 4, BookingTableMap::COL_NOTES => 5, BookingTableMap::COL_STATUS => 6, BookingTableMap::COL_GUEST_ID => 7, BookingTableMap::COL_FAX => 8, BookingTableMap::COL_AUTHOR_ID => 9, BookingTableMap::COL_ENTRY_DATE => 10, BookingTableMap::COL_EDIT_DATE => 11, BookingTableMap::COL_PERSONALIZED => 12, BookingTableMap::COL_ROOM_ID => 13, BookingTableMap::COL_RESTRICTIONS => 14, BookingTableMap::COL_PACKAGE_TYPE_ID => 15, BookingTableMap::COL_IS_ACTIVE => 16, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Booking');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BookingTableMap::COL_BOOKING_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_TITLE);
            $criteria->addSelectColumn(BookingTableMap::COL_PACKAGE_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_START_DATE);
            $criteria->addSelectColumn(BookingTableMap::COL_END_DATE);
            $criteria->addSelectColumn(BookingTableMap::COL_NOTES);
            $criteria->addSelectColumn(BookingTableMap::COL_STATUS);
            $criteria->addSelectColumn(BookingTableMap::COL_GUEST_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_FAX);
            $criteria->addSelectColumn(BookingTableMap::COL_AUTHOR_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_ENTRY_DATE);
            $criteria->addSelectColumn(BookingTableMap::COL_EDIT_DATE);
            $criteria->addSelectColumn(BookingTableMap::COL_PERSONALIZED);
            $criteria->addSelectColumn(BookingTableMap::COL_ROOM_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_RESTRICTIONS);
            $criteria->addSelectColumn(BookingTableMap::COL_PACKAGE_TYPE_ID);
            $criteria->addSelectColumn(BookingTableMap::COL_IS_ACTIVE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Booking) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(BookingTableMap::DATABASE_NAME);
            $criteria->add(BookingTableMap::COL_BOOKING_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(BookingTableMap::COL_BOOKING_ID) && $criteria->keyContainsValue(BookingTableMap::COL_BOOKING_ID) ) {
