...
use TheFarm\Models\Migrations;
use TheFarm\Models\MigrationsQuery;
...
class MigrationsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.MigrationsTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Migrations';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Migrations';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Migrations');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Migrations) { // it's a model object
