...
use TheFarm\Models\Categories;
use TheFarm\Models\CategoriesQuery;
...
class CategoriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.CategoriesTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Categories';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Categories';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_CAT_ID, CategoriesTableMap::COL_CAT_NAME, CategoriesTableMap::COL_CAT_IMAGE, CategoriesTableMap::COL_CAT_BODY, CategoriesTableMap::COL_PARENT_ID, CategoriesTableMap::COL_LOCATION_ID, CategoriesTableMap::COL_CAT_BG_COLOR, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_CAT_ID => 0, CategoriesTableMap::COL_CAT_NAME => 1, CategoriesTableMap::COL_CAT_IMAGE => 2, CategoriesTableMap::COL_CAT_BODY => 3, CategoriesTableMap::COL_PARENT_ID => 4, CategoriesTableMap::COL_LOCATION_ID => 5, CategoriesTableMap::COL_CAT_BG_COLOR => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Categories');
  ...
  array (
    ...
    1 => ':location_id',
        ...
        $this->addRelation('CategoriesRelatedByParentId', '\\TheFarm\\Models\\Categories', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':parent_id',
    1 => ':cat_id',
        ...
        $this->addRelation('CategoriesRelatedByCatId', '\\TheFarm\\Models\\Categories', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':parent_id',
    1 => ':cat_id',
  ),
), null, null, 'CategoriessRelatedByCatId', false);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoriesTableMap::COL_CAT_ID);
            $criteria->addSelectColumn(CategoriesTableMap::COL_CAT_NAME);
            $criteria->addSelectColumn(CategoriesTableMap::COL_CAT_IMAGE);
            $criteria->addSelectColumn(CategoriesTableMap::COL_CAT_BODY);
            $criteria->addSelectColumn(CategoriesTableMap::COL_PARENT_ID);
            $criteria->addSelectColumn(CategoriesTableMap::COL_LOCATION_ID);
            $criteria->addSelectColumn(CategoriesTableMap::COL_CAT_BG_COLOR);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Categories) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(CategoriesTableMap::DATABASE_NAME);
            $criteria->add(CategoriesTableMap::COL_CAT_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoriesTableMap::COL_CAT_ID) && $criteria->keyContainsValue(CategoriesTableMap::COL_CAT_ID) ) {
