...
use TheFarm\Models\BookingEventUsers;
use TheFarm\Models\BookingEventUsersQuery;
 ...
 *
 */
class BookingEventUsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.BookingEventUsersTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\BookingEventUsers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.BookingEventUsers';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(BookingEventUsersTableMap::COL_EVENT_ID, BookingEventUsersTableMap::COL_STAFF_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(BookingEventUsersTableMap::COL_EVENT_ID => 0, BookingEventUsersTableMap::COL_STAFF_ID => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('BookingEventUsers');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\TheFarm\\Models\\BookingEventUsers');
    ...
    {
        $this->addRelation('BookingEvents', '\\TheFarm\\Models\\BookingEvents', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':event_id',
    1 => ':event_id',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \TheFarm\Models\BookingEventUsers $obj A \TheFarm\Models\BookingEventUsers object.
     ...
     *
     * @param mixed $value A \TheFarm\Models\BookingEventUsers object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \TheFarm\Models\BookingEventUsers) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \TheFarm\Models\BookingEventUsers object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? BookingEventUsersTableMap::CLASS_DEFAULT : BookingEventUsersTableMap::OM_CLASS;
    }
     ...
     * @return array           (BookingEventUsers object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = BookingEventUsersTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = BookingEventUsersTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + BookingEventUsersTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = BookingEventUsersTableMap::OM_CLASS;
            /** @var BookingEventUsers $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            BookingEventUsersTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = BookingEventUsersTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = BookingEventUsersTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BookingEventUsersTableMap::COL_EVENT_ID);
            $criteria->addSelectColumn(BookingEventUsersTableMap::COL_STAFF_ID);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(BookingEventUsersTableMap::DATABASE_NAME)->getTable(BookingEventUsersTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(BookingEventUsersTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(BookingEventUsersTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new BookingEventUsersTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a BookingEventUsers or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or BookingEventUsers object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\BookingEventUsers) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(BookingEventUsersTableMap::COL_EVENT_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(BookingEventUsersTableMap::COL_STAFF_ID, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = BookingEventUsersQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            BookingEventUsersTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                BookingEventUsersTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return BookingEventUsersQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a BookingEventUsers or Criteria object.
     *
     * @param mixed               $criteria Criteria or BookingEventUsers object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from BookingEventUsers object
        }
...
} // BookingEventUsersTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BookingEventUsersTableMap::buildTableMap();
