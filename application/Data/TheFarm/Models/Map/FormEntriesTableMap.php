...
use TheFarm\Models\FormEntries;
use TheFarm\Models\FormEntriesQuery;
 ...
 *
 */
class FormEntriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.FormEntriesTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\FormEntries';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.FormEntries';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FormEntriesTableMap::COL_ENTRY_ID, FormEntriesTableMap::COL_BOOKING_ID, FormEntriesTableMap::COL_FORM_ID, FormEntriesTableMap::COL_FIELD_ID, FormEntriesTableMap::COL_FIELD_TEXT_VALUE, FormEntriesTableMap::COL_FIELD_DROPDOWN_VALUE, FormEntriesTableMap::COL_FIELD_CHECKBOXES_VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FormEntriesTableMap::COL_ENTRY_ID => 0, FormEntriesTableMap::COL_BOOKING_ID => 1, FormEntriesTableMap::COL_FORM_ID => 2, FormEntriesTableMap::COL_FIELD_ID => 3, FormEntriesTableMap::COL_FIELD_TEXT_VALUE => 4, FormEntriesTableMap::COL_FIELD_DROPDOWN_VALUE => 5, FormEntriesTableMap::COL_FIELD_CHECKBOXES_VALUE => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('FormEntries');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\TheFarm\\Models\\FormEntries');
  ...
  array (
    ...
    1 => ':booking_id',
        ...
        $this->addRelation('Fields', '\\TheFarm\\Models\\Fields', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':field_id',
    1 => ':field_id',
        ...
        $this->addRelation('Forms', '\\TheFarm\\Models\\Forms', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':form_id',
    1 => ':form_id',
    ...
    {
        return $withPrefix ? FormEntriesTableMap::CLASS_DEFAULT : FormEntriesTableMap::OM_CLASS;
    }
     ...
     * @return array           (FormEntries object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = FormEntriesTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = FormEntriesTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + FormEntriesTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = FormEntriesTableMap::OM_CLASS;
            /** @var FormEntries $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            FormEntriesTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = FormEntriesTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = FormEntriesTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FormEntriesTableMap::COL_ENTRY_ID);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_BOOKING_ID);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_FORM_ID);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_FIELD_ID);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_FIELD_TEXT_VALUE);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_FIELD_DROPDOWN_VALUE);
            $criteria->addSelectColumn(FormEntriesTableMap::COL_FIELD_CHECKBOXES_VALUE);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(FormEntriesTableMap::DATABASE_NAME)->getTable(FormEntriesTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(FormEntriesTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(FormEntriesTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new FormEntriesTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a FormEntries or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or FormEntries object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\FormEntries) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(FormEntriesTableMap::DATABASE_NAME);
            $criteria->add(FormEntriesTableMap::COL_ENTRY_ID, (array) $values, Criteria::IN);
        }

        $query = FormEntriesQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            FormEntriesTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                FormEntriesTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return FormEntriesQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a FormEntries or Criteria object.
     *
     * @param mixed               $criteria Criteria or FormEntries object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from FormEntries object
        }

        if ($criteria->containsKey(FormEntriesTableMap::COL_ENTRY_ID) && $criteria->keyContainsValue(FormEntriesTableMap::COL_ENTRY_ID) ) {
...
//
FormEntriesTableMap::buildTableMap();
