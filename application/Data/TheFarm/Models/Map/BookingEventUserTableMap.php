...
use TheFarm\Models\BookingEventUser;
use TheFarm\Models\BookingEventUserQuery;
 ...
 *
 */
class BookingEventUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.BookingEventUserTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\BookingEventUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.BookingEventUser';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('BookingEventUser');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\TheFarm\\Models\\BookingEventUser');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \TheFarm\Models\BookingEventUser $obj A \TheFarm\Models\BookingEventUser object.
     ...
     *
     * @param mixed $value A \TheFarm\Models\BookingEventUser object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \TheFarm\Models\BookingEventUser) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \TheFarm\Models\BookingEventUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? BookingEventUserTableMap::CLASS_DEFAULT : BookingEventUserTableMap::OM_CLASS;
    }
     ...
     * @return array           (BookingEventUser object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = BookingEventUserTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = BookingEventUserTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + BookingEventUserTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = BookingEventUserTableMap::OM_CLASS;
            /** @var BookingEventUser $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            BookingEventUserTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = BookingEventUserTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = BookingEventUserTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(BookingEventUserTableMap::DATABASE_NAME)->getTable(BookingEventUserTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(BookingEventUserTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(BookingEventUserTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new BookingEventUserTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a BookingEventUser or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or BookingEventUser object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\BookingEventUser) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(BookingEventUserTableMap::COL_EVENT_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(BookingEventUserTableMap::COL_STAFF_ID, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = BookingEventUserQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            BookingEventUserTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                BookingEventUserTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return BookingEventUserQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a BookingEventUser or Criteria object.
     *
     * @param mixed               $criteria Criteria or BookingEventUser object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from BookingEventUser object
        }
...
} // BookingEventUserTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BookingEventUserTableMap::buildTableMap();
