...
class UserWorkPlanDayTableMap extends TableMap
{
    ...
    /**
     * the column name for the work_code field
     */
    const COL_WORK_CODE = 'tf_user_work_plan_day.work_code';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserWorkPlanDayTableMap::COL_WORK_CODE);
        } else {
            $criteria->addSelectColumn($alias . '.contact_id');
            $criteria->addSelectColumn($alias . '.date');
            $criteria->addSelectColumn($alias . '.work_code');
        }
    }
