...
use TheFarm\Models\Location;
use TheFarm\Models\LocationQuery;
...
class LocationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.LocationTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Location';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Location';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_LOCATION_ID, LocationTableMap::COL_LOCATION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_LOCATION_ID => 0, LocationTableMap::COL_LOCATION => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Location');
  ...
  array (
    ...
    1 => ':location_id',
        ...
        $this->addRelation('Facility', '\\TheFarm\\Models\\Facility', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':location_id',
    1 => ':location_id',
  ),
), null, null, 'Facilities', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationTableMap::COL_LOCATION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Location) { // it's a model object
