 ...
 */
abstract class Forms implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\FormsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Forms object.
     */
    ...
    /**
     * Compares this with another <code>Forms</code> instance.  If
     * <code>obj</code> is an instance of <code>Forms</code>, delegates to
     * <code>equals(Forms)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Forms The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\Forms The current object (for fluent API support)
     */
    public function setFormId($v)
    {
        ...
        if ($this->form_id !== $v) {
            $this->form_id = $v;
            $this->modifiedColumns[FormsTableMap::COL_FORM_ID] = true;
        }
    ...
    public function setFormName($v)
    {
        ...
        if ($this->form_name !== $v) {
            $this->form_name = $v;
            $this->modifiedColumns[FormsTableMap::COL_FORM_NAME] = true;
        }
    ...
    public function setFormHtml($v)
    {
        ...
        if ($this->form_html !== $v) {
            $this->form_html = $v;
            $this->modifiedColumns[FormsTableMap::COL_FORM_HTML] = true;
        }
    ...
    public function setFieldIds($v)
    {
        ...
        if ($this->field_ids !== $v) {
            $this->field_ids = $v;
            $this->modifiedColumns[FormsTableMap::COL_FIELD_IDS] = true;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[FormsTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function setEntryDate($v)
    {
        ...
        if ($this->entry_date !== $v) {
            $this->entry_date = $v;
            $this->modifiedColumns[FormsTableMap::COL_ENTRY_DATE] = true;
        }
    ...
    public function setEditDate($v)
    {
        ...
        if ($this->edit_date !== $v) {
            $this->edit_date = $v;
            $this->modifiedColumns[FormsTableMap::COL_EDIT_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FormsTableMap::translateFieldName('FormId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->form_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FormsTableMap::translateFieldName('FormName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->form_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FormsTableMap::translateFieldName('FormHtml', TableMap::TYPE_PHPNAME, $indexType)];
            $this->form_html = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FormsTableMap::translateFieldName('FieldIds', TableMap::TYPE_PHPNAME, $indexType)];
            $this->field_ids = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FormsTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->author_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FormsTableMap::translateFieldName('EntryDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entry_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FormsTableMap::translateFieldName('EditDate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = FormsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Forms'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFormsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFormsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FormsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FormsTableMap::COL_FORM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'form_id';
        }
        if ($this->isColumnModified(FormsTableMap::COL_FORM_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'form_name';
        }
        if ($this->isColumnModified(FormsTableMap::COL_FORM_HTML)) {
            $modifiedColumns[':p' . $index++]  = 'form_html';
        }
        if ($this->isColumnModified(FormsTableMap::COL_FIELD_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'field_ids';
        }
        if ($this->isColumnModified(FormsTableMap::COL_AUTHOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'author_id';
        }
        if ($this->isColumnModified(FormsTableMap::COL_ENTRY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'entry_date';
        }
        if ($this->isColumnModified(FormsTableMap::COL_EDIT_DATE)) {
    ...
    {
        $pos = FormsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Forms'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Forms'][$this->hashCode()] = true;
        $keys = FormsTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Forms
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Forms The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormsTableMap::COL_FORM_ID)) {
            $criteria->add(FormsTableMap::COL_FORM_ID, $this->form_id);
        }
        if ($this->isColumnModified(FormsTableMap::COL_FORM_NAME)) {
            $criteria->add(FormsTableMap::COL_FORM_NAME, $this->form_name);
        }
        if ($this->isColumnModified(FormsTableMap::COL_FORM_HTML)) {
            $criteria->add(FormsTableMap::COL_FORM_HTML, $this->form_html);
        }
        if ($this->isColumnModified(FormsTableMap::COL_FIELD_IDS)) {
            $criteria->add(FormsTableMap::COL_FIELD_IDS, $this->field_ids);
        }
        if ($this->isColumnModified(FormsTableMap::COL_AUTHOR_ID)) {
            $criteria->add(FormsTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(FormsTableMap::COL_ENTRY_DATE)) {
            $criteria->add(FormsTableMap::COL_ENTRY_DATE, $this->entry_date);
        }
        if ($this->isColumnModified(FormsTableMap::COL_EDIT_DATE)) {
            $criteria->add(FormsTableMap::COL_EDIT_DATE, $this->edit_date);
        }
    ...
    {
        $criteria = ChildFormsQuery::create();
        $criteria->add(FormsTableMap::COL_FORM_ID, $this->form_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Forms (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Forms Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildForms is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildForms The current object (for fluent API support)
     */
    public function setFormEntriess(Collection $formEntriess, ConnectionInterface $con = null)
    {
        ...
        foreach ($formEntriessToDelete as $formEntriesRemoved) {
            $formEntriesRemoved->setForms(null);
        }
     ...
     * Otherwise if this Forms is new, it will return
     * an empty collection; or if this Forms has previously
     * been saved, it will retrieve related FormEntriess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Forms.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(FormsTableMap::DEFAULT_STRING_FORMAT);
    }
