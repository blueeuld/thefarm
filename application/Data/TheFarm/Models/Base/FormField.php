 ...
 */
abstract class FormField implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\FormFieldTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\FormField object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>FormField</code> instance.  If
     * <code>obj</code> is an instance of <code>FormField</code>, delegates to
     * <code>equals(FormField)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|FormField The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FormFieldTableMap::translateFieldName('FieldId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = FormFieldTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\FormField'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFormFieldQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FormField::setDeleted()
     * @see FormField::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFormFieldQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FormFieldTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FormFieldTableMap::COL_FIELD_ID)) {
    ...
    {
        $pos = FormFieldTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['FormField'][$this->hashCode()] = true;
        $keys = FormFieldTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\FormField
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\FormField The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormFieldTableMap::COL_FIELD_ID)) {
            $criteria->add(FormFieldTableMap::COL_FIELD_ID, $this->field_id);
        }
        if ($this->isColumnModified(FormFieldTableMap::COL_FORM_ID)) {
    ...
    {
        $criteria = ChildFormFieldQuery::create();
        $criteria->add(FormFieldTableMap::COL_FIELD_ID, $this->field_id);
        $criteria->add(FormFieldTableMap::COL_FORM_ID, $this->form_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\FormField (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\FormField Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(FormFieldTableMap::DEFAULT_STRING_FORMAT);
    }
