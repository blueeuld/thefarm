...
/**
 * Base class that represents a row from the 'tf_user_work_plan_time' table.
 *
 *
 *
 * @package    propel.generator.TheFarm.Models.Base
 */
abstract class ProviderSchedule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\ProviderScheduleTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\ProviderSchedule object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ProviderSchedule</code> instance.  If
     * <code>obj</code> is an instance of <code>ProviderSchedule</code>, delegates to
     * <code>equals(ProviderSchedule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ProviderSchedule The current object, for fluid interface
     */
    ...
    public function setWorkPlanCd($v)
    {
        ...
        if ($this->work_plan_cd !== $v) {
            $this->work_plan_cd = $v;
            $this->modifiedColumns[ProviderScheduleTableMap::COL_WORK_PLAN_CD] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->start_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ProviderScheduleTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($this->end_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->end_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ProviderScheduleTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function setIsWorking($v)
    {
        ...
        if ($this->is_working !== $v) {
            $this->is_working = $v;
            $this->modifiedColumns[ProviderScheduleTableMap::COL_IS_WORKING] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProviderScheduleTableMap::translateFieldName('WorkPlanCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->work_plan_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProviderScheduleTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProviderScheduleTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProviderScheduleTableMap::translateFieldName('IsWorking', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ProviderScheduleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\ProviderSchedule'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProviderScheduleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProviderSchedule::setDeleted()
     * @see ProviderSchedule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProviderScheduleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProviderScheduleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_WORK_PLAN_CD)) {
        ...
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_IS_WORKING)) {
    ...
    {
        $pos = ProviderScheduleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProviderSchedule'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        $result = array(
            ...
            $keys[1] => $this->getWorkPlanCd(),
            $keys[2] => $this->getStartDate(),
            $keys[3] => $this->getEndDate(),
            $keys[4] => $this->getIsWorking(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\ProviderSchedule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\ProviderSchedule The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_WORK_PLAN_CD)) {
            $criteria->add(ProviderScheduleTableMap::COL_WORK_PLAN_CD, $this->work_plan_cd);
        }
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_START_DATE)) {
        ...
        if ($this->isColumnModified(ProviderScheduleTableMap::COL_IS_WORKING)) {
            $criteria->add(ProviderScheduleTableMap::COL_IS_WORKING, $this->is_working);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\ProviderSchedule (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\ProviderSchedule Clone of current object.
     * @throws PropelException
     */
    ...
    public function setWorkPlan(ChildWorkPlan $v = null)
    {
        if ($v === null) {
            ...
            $this->setWorkPlanCd($v->getWorkPlanCd());
        }
    ...
    public function getWorkPlan(ConnectionInterface $con = null)
    {
        if ($this->aWorkPlan === null && (($this->work_plan_cd !== "" && $this->work_plan_cd !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWorkPlan->addProviderSchedules($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aWorkPlan) {
            $this->aWorkPlan->removeProviderSchedule($this);
        }
    ...
    {
        return (string) $this->exportTo(ProviderScheduleTableMap::DEFAULT_STRING_FORMAT);
    }
