...
use TheFarm\Models\Site as ChildSite;
use TheFarm\Models\SiteQuery as ChildSiteQuery;
use TheFarm\Models\Map\SiteTableMap;
 ...
 *
 *
 * @method     ChildSiteQuery orderBySiteId($order = Criteria::ASC) Order by the site_id column
 * @method     ChildSiteQuery orderBySiteTitle($order = Criteria::ASC) Order by the site_title column
 * @method     ChildSiteQuery orderBySiteSystemPreferences($order = Criteria::ASC) Order by the site_system_preferences column
 *
 * @method     ChildSiteQuery groupBySiteId() Group by the site_id column
 * @method     ChildSiteQuery groupBySiteTitle() Group by the site_title column
 * @method     ChildSiteQuery groupBySiteSystemPreferences() Group by the site_system_preferences column
 *
 ...
 *
 * @method     ChildSite findOneBySiteId(int $site_id) Return the first ChildSite filtered by the site_id column
 * @method     ChildSite findOneBySiteTitle(string $site_title) Return the first ChildSite filtered by the site_title column
 * @method     ChildSite findOneBySiteSystemPreferences(string $site_system_preferences) Return the first ChildSite filtered by the site_system_preferences column *
 ...
 *
 * @method     ChildSite requireOneBySiteId(int $site_id) Return the first ChildSite filtered by the site_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSite requireOneBySiteTitle(string $site_title) Return the first ChildSite filtered by the site_title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSite requireOneBySiteSystemPreferences(string $site_system_preferences) Return the first ChildSite filtered by the site_system_preferences column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSite[]|ObjectCollection findBySiteId(int $site_id) Return ChildSite objects filtered by the site_id column
 * @method     ChildSite[]|ObjectCollection findBySiteTitle(string $site_title) Return ChildSite objects filtered by the site_title column
 * @method     ChildSite[]|ObjectCollection findBySiteSystemPreferences(string $site_system_preferences) Return ChildSite objects filtered by the site_system_preferences column
...
abstract class SiteQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \TheFarm\Models\Base\SiteQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\TheFarm\\Models\\Site', $modelAlias = null)
    {
    ...
    public function filterBySiteId($siteId = null, $comparison = null)
    {
        if (is_array($siteId)) {
            $useMinMax = false;
            if (isset($siteId['min'])) {
                $this->addUsingAlias(SiteTableMap::COL_SITE_ID, $siteId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($siteId['max'])) {
                $this->addUsingAlias(SiteTableMap::COL_SITE_ID, $siteId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SiteTableMap::COL_SITE_ID, $siteId, $comparison);
    }
    ...
    public function filterBySiteTitle($siteTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SiteTableMap::COL_SITE_TITLE, $siteTitle, $comparison);
    }
    ...
    public function filterBySiteSystemPreferences($siteSystemPreferences = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SiteTableMap::COL_SITE_SYSTEM_PREFERENCES, $siteSystemPreferences, $comparison);
    }
    ...
    {
        if ($site) {
            $this->addUsingAlias(SiteTableMap::COL_SITE_ID, $site->getSiteId(), Criteria::NOT_EQUAL);
        }
