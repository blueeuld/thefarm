...
abstract class Statuses implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\StatusesTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Statuses object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|Statuses The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\Statuses The current object (for fluent API support)
     */
    public function setStatusId($v)
    {
        ...
        if ($this->status_id !== $v) {
            $this->status_id = $v;
            $this->modifiedColumns[StatusesTableMap::COL_STATUS_ID] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[StatusesTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function setStatusCd($v)
    {
        ...
        if ($this->status_cd !== $v) {
            $this->status_cd = $v;
            $this->modifiedColumns[StatusesTableMap::COL_STATUS_CD] = true;
        }
    ...
    public function setStatusName($v)
    {
        ...
        if ($this->status_name !== $v) {
            $this->status_name = $v;
            $this->modifiedColumns[StatusesTableMap::COL_STATUS_NAME] = true;
        }
    ...
    public function setStatusOrder($v)
    {
        ...
        if ($this->status_order !== $v) {
            $this->status_order = $v;
            $this->modifiedColumns[StatusesTableMap::COL_STATUS_ORDER] = true;
        }
    ...
    public function setStatusStyle($v)
    {
        ...
        if ($this->status_style !== $v) {
            $this->status_style = $v;
            $this->modifiedColumns[StatusesTableMap::COL_STATUS_STYLE] = true;
        }
    ...
    public function setIncludeInSales($v)
    {
        ...
        if ($this->include_in_sales !== $v) {
            ...
            $this->modifiedColumns[StatusesTableMap::COL_INCLUDE_IN_SALES] = true;
        }
    ...
    public function setIncludeInDuplicateChecking($v)
    {
        ...
        if ($this->include_in_duplicate_checking !== $v) {
            ...
            $this->modifiedColumns[StatusesTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StatusesTableMap::translateFieldName('StatusId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StatusesTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StatusesTableMap::translateFieldName('StatusCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StatusesTableMap::translateFieldName('StatusName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StatusesTableMap::translateFieldName('StatusOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StatusesTableMap::translateFieldName('StatusStyle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_style = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : StatusesTableMap::translateFieldName('IncludeInSales', TableMap::TYPE_PHPNAME, $indexType)];
            $this->include_in_sales = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : StatusesTableMap::translateFieldName('IncludeInDuplicateChecking', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = StatusesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Statuses'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'status_id';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'group_id';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_CD)) {
            $modifiedColumns[':p' . $index++]  = 'status_cd';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'status_name';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'status_order';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_STYLE)) {
            $modifiedColumns[':p' . $index++]  = 'status_style';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_INCLUDE_IN_SALES)) {
            $modifiedColumns[':p' . $index++]  = 'include_in_sales';
        }
        if ($this->isColumnModified(StatusesTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Statuses
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Statuses The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_ID)) {
            $criteria->add(StatusesTableMap::COL_STATUS_ID, $this->status_id);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_GROUP_ID)) {
            $criteria->add(StatusesTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_CD)) {
            $criteria->add(StatusesTableMap::COL_STATUS_CD, $this->status_cd);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_NAME)) {
            $criteria->add(StatusesTableMap::COL_STATUS_NAME, $this->status_name);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_ORDER)) {
            $criteria->add(StatusesTableMap::COL_STATUS_ORDER, $this->status_order);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_STATUS_STYLE)) {
            $criteria->add(StatusesTableMap::COL_STATUS_STYLE, $this->status_style);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_INCLUDE_IN_SALES)) {
            $criteria->add(StatusesTableMap::COL_INCLUDE_IN_SALES, $this->include_in_sales);
        }
        if ($this->isColumnModified(StatusesTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING)) {
            $criteria->add(StatusesTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING, $this->include_in_duplicate_checking);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Statuses (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Statuses Clone of current object.
     * @throws PropelException
     */
