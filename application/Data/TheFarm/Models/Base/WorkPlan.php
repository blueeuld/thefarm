...
/**
 * Base class that represents a row from the 'tf_work_plan' table.
 *
 *
 *
 * @package    propel.generator.TheFarm.Models.Base
 */
abstract class WorkPlan implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\WorkPlanTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\WorkPlan object.
     */
    ...
    /**
     * Compares this with another <code>WorkPlan</code> instance.  If
     * <code>obj</code> is an instance of <code>WorkPlan</code>, delegates to
     * <code>equals(WorkPlan)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WorkPlan The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\WorkPlan The current object (for fluent API support)
     */
    public function setWorkPlanCd($v)
    {
        ...
        if ($this->work_plan_cd !== $v) {
            $this->work_plan_cd = $v;
            $this->modifiedColumns[WorkPlanTableMap::COL_WORK_PLAN_CD] = true;
        }
    ...
    public function setWorkPlanName($v)
    {
        ...
        if ($this->work_plan_name !== $v) {
            ...
            $this->modifiedColumns[WorkPlanTableMap::COL_WORK_PLAN_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WorkPlanTableMap::translateFieldName('WorkPlanCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->work_plan_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WorkPlanTableMap::translateFieldName('WorkPlanName', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = WorkPlanTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\WorkPlan'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWorkPlanQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WorkPlan::setDeleted()
     * @see WorkPlan::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWorkPlanQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WorkPlanTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WorkPlanTableMap::COL_WORK_PLAN_CD)) {
            $modifiedColumns[':p' . $index++]  = 'work_plan_cd';
        }
        if ($this->isColumnModified(WorkPlanTableMap::COL_WORK_PLAN_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'work_plan_name';
        }

        $sql = sprintf(
            'INSERT INTO tf_work_plan (%s) VALUES (%s)',
    ...
    {
        $pos = WorkPlanTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WorkPlan'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WorkPlan'][$this->hashCode()] = true;
        $keys = WorkPlanTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\WorkPlan
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\WorkPlan The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WorkPlanTableMap::COL_WORK_PLAN_CD)) {
            $criteria->add(WorkPlanTableMap::COL_WORK_PLAN_CD, $this->work_plan_cd);
        }
        if ($this->isColumnModified(WorkPlanTableMap::COL_WORK_PLAN_NAME)) {
            $criteria->add(WorkPlanTableMap::COL_WORK_PLAN_NAME, $this->work_plan_name);
        }
    ...
    {
        $criteria = ChildWorkPlanQuery::create();
        $criteria->add(WorkPlanTableMap::COL_WORK_PLAN_CD, $this->work_plan_cd);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\WorkPlan (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\WorkPlan Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildWorkPlan is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildWorkPlan The current object (for fluent API support)
     */
    public function setUserWorkPlanDays(Collection $userWorkPlanDays, ConnectionInterface $con = null)
    {
        ...
        foreach ($userWorkPlanDaysToDelete as $userWorkPlanDayRemoved) {
            $userWorkPlanDayRemoved->setWorkPlan(null);
        }
    ...
    protected function doAddUserWorkPlanDay(ChildUserWorkPlanDay $userWorkPlanDay)
    {
        ...
        $userWorkPlanDay->setWorkPlan($this);
    }
    ...
    public function removeUserWorkPlanDay(ChildUserWorkPlanDay $userWorkPlanDay)
    {
        if ($this->getUserWorkPlanDays()->contains($userWorkPlanDay)) {
            ...
            $userWorkPlanDay->setWorkPlan(null);
        }
     ...
     * Otherwise if this WorkPlan is new, it will return
     * an empty collection; or if this WorkPlan has previously
     * been saved, it will retrieve related UserWorkPlanDays from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in WorkPlan.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @param string $startDate,
     * @param string $endDate
     * @return ChildWorkPlan The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(WorkPlanTableMap::DEFAULT_STRING_FORMAT);
    }
