...
use TheFarm\Models\MigrationsQuery as ChildMigrationsQuery;
use TheFarm\Models\Map\MigrationsTableMap;
...
abstract class Migrations implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\MigrationsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Migrations object.
     */
     ...
     * @return $this|\TheFarm\Models\Migrations The current object (for fluent API support)
     */
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[MigrationsTableMap::COL_VERSION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MigrationsTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Migrations'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MigrationsTableMap::COL_VERSION)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Migrations
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Migrations The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MigrationsTableMap::COL_VERSION)) {
            $criteria->add(MigrationsTableMap::COL_VERSION, $this->version);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Migrations (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Migrations Clone of current object.
     * @throws PropelException
     */
