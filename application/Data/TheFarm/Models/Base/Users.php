...
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Users object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\TheFarm\Models\Users The current object (for fluent API support)
     */
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[UsersTableMap::COL_CONTACT_ID] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[UsersTableMap::COL_GROUP_ID] = true;
        }

        if ($this->aGroups !== null && $this->aGroups->getGroupId() !== $v) {
            $this->aGroups = null;
        }
    ...
    public function setWorkPlan($v)
    {
        ...
        if ($this->work_plan !== $v) {
            $this->work_plan = $v;
            $this->modifiedColumns[UsersTableMap::COL_WORK_PLAN] = true;
        }
    ...
    public function setWorkPlanCode($v)
    {
        ...
        if ($this->work_plan_code !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_WORK_PLAN_CODE] = true;
        }
    ...
    public function setLocationId($v)
    {
        ...
        if ($this->location_id !== $v) {
            $this->location_id = $v;
            $this->modifiedColumns[UsersTableMap::COL_LOCATION_ID] = true;
        }
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[UsersTableMap::COL_ORDER] = true;
        }
    ...
    public function setCalendarViewPositions($v)
    {
        ...
        if ($this->calendar_view_positions !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_CALENDAR_VIEW_POSITIONS] = true;
        }
    ...
    public function setCalendarViewStatus($v)
    {
        ...
        if ($this->calendar_view_status !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_CALENDAR_VIEW_STATUS] = true;
        }
    ...
    public function setCalendarShowMyScheduleOnly($v)
    {
        ...
        if ($this->calendar_show_my_schedule_only !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_CALENDAR_SHOW_MY_SCHEDULE_ONLY] = true;
        }
    ...
    public function setCalendarViewLocations($v)
    {
        ...
        if ($this->calendar_view_locations !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_CALENDAR_VIEW_LOCATIONS] = true;
        }
    ...
    public function setPreferences($v)
    {
        ...
        if ($this->preferences !== $v) {
            $this->preferences = $v;
            $this->modifiedColumns[UsersTableMap::COL_PREFERENCES] = true;
        }
    ...
    public function setCalendarShowNoSchedule($v)
    {
        ...
        if ($this->calendar_show_no_schedule !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_CALENDAR_SHOW_NO_SCHEDULE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UsersTableMap::translateFieldName('ContactId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsersTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('WorkPlan', TableMap::TYPE_PHPNAME, $indexType)];
            $this->work_plan = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UsersTableMap::translateFieldName('WorkPlanCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->work_plan_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UsersTableMap::translateFieldName('LocationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UsersTableMap::translateFieldName('FacebookId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->facebook_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UsersTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UsersTableMap::translateFieldName('CalendarViewPositions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calendar_view_positions = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UsersTableMap::translateFieldName('CalendarViewStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calendar_view_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UsersTableMap::translateFieldName('CalendarShowMyScheduleOnly', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calendar_show_my_schedule_only = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UsersTableMap::translateFieldName('CalendarViewLocations', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calendar_view_locations = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : UsersTableMap::translateFieldName('Preferences', TableMap::TYPE_PHPNAME, $indexType)];
            $this->preferences = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : UsersTableMap::translateFieldName('CalendarShowNoSchedule', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 16; // 16 = UsersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Users'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGroups !== null && $this->group_id !== $this->aGroups->getGroupId()) {
            $this->aGroups = null;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'contact_id';
        }
        if ($this->isColumnModified(UsersTableMap::COL_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'username';
        }
        if ($this->isColumnModified(UsersTableMap::COL_GROUP_ID)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_WORK_PLAN)) {
            $modifiedColumns[':p' . $index++]  = 'work_plan';
        }
        if ($this->isColumnModified(UsersTableMap::COL_WORK_PLAN_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'work_plan_code';
        }
        if ($this->isColumnModified(UsersTableMap::COL_LOCATION_ID)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'order';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_POSITIONS)) {
            $modifiedColumns[':p' . $index++]  = 'calendar_view_positions';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'calendar_view_status';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_SHOW_MY_SCHEDULE_ONLY)) {
            $modifiedColumns[':p' . $index++]  = 'calendar_show_my_schedule_only';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_LOCATIONS)) {
            $modifiedColumns[':p' . $index++]  = 'calendar_view_locations';
        }
        if ($this->isColumnModified(UsersTableMap::COL_PREFERENCES)) {
            $modifiedColumns[':p' . $index++]  = 'preferences';
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_SHOW_NO_SCHEDULE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Users
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Users The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_CONTACT_ID)) {
            $criteria->add(UsersTableMap::COL_CONTACT_ID, $this->contact_id);
        }
        if ($this->isColumnModified(UsersTableMap::COL_USERNAME)) {
            $criteria->add(UsersTableMap::COL_USERNAME, $this->username);
        }
        if ($this->isColumnModified(UsersTableMap::COL_GROUP_ID)) {
            $criteria->add(UsersTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(UsersTableMap::COL_LAST_LOGIN)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_WORK_PLAN)) {
            $criteria->add(UsersTableMap::COL_WORK_PLAN, $this->work_plan);
        }
        if ($this->isColumnModified(UsersTableMap::COL_WORK_PLAN_CODE)) {
            $criteria->add(UsersTableMap::COL_WORK_PLAN_CODE, $this->work_plan_code);
        }
        if ($this->isColumnModified(UsersTableMap::COL_LOCATION_ID)) {
            $criteria->add(UsersTableMap::COL_LOCATION_ID, $this->location_id);
        }
        if ($this->isColumnModified(UsersTableMap::COL_FACEBOOK_ID)) {
            $criteria->add(UsersTableMap::COL_FACEBOOK_ID, $this->facebook_id);
        }
        if ($this->isColumnModified(UsersTableMap::COL_ORDER)) {
            $criteria->add(UsersTableMap::COL_ORDER, $this->order);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_POSITIONS)) {
            $criteria->add(UsersTableMap::COL_CALENDAR_VIEW_POSITIONS, $this->calendar_view_positions);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_STATUS)) {
            $criteria->add(UsersTableMap::COL_CALENDAR_VIEW_STATUS, $this->calendar_view_status);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_SHOW_MY_SCHEDULE_ONLY)) {
            $criteria->add(UsersTableMap::COL_CALENDAR_SHOW_MY_SCHEDULE_ONLY, $this->calendar_show_my_schedule_only);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_VIEW_LOCATIONS)) {
            $criteria->add(UsersTableMap::COL_CALENDAR_VIEW_LOCATIONS, $this->calendar_view_locations);
        }
        if ($this->isColumnModified(UsersTableMap::COL_PREFERENCES)) {
            $criteria->add(UsersTableMap::COL_PREFERENCES, $this->preferences);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CALENDAR_SHOW_NO_SCHEDULE)) {
            $criteria->add(UsersTableMap::COL_CALENDAR_SHOW_NO_SCHEDULE, $this->calendar_show_no_schedule);
        }
    ...
    public function hashCode()
    {
        ...
        if ($this->aContacts && $hash = spl_object_hash($this->aContacts)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Users Clone of current object.
     * @throws PropelException
     */
    ...
    public function getLocations(ConnectionInterface $con = null)
    {
        if ($this->aLocations === null && ($this->location_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLocations->addUserss($this);
             */
        }
    ...
    {
        if (null !== $this->aContacts) {
            $this->aContacts->removeUsers($this);
        }
        if (null !== $this->aGroups) {
            $this->aGroups->removeUsers($this);
        }
        if (null !== $this->aLocations) {
            $this->aLocations->removeUsers($this);
        }
