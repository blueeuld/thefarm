 ...
 * @method     ChildLocationQuery orderByLocation($order = Criteria::ASC) Order by the location column
 *
 * @method     ChildLocationQuery groupByLocationId() Group by the location_id column
 * @method     ChildLocationQuery groupByLocation() Group by the location column
 *
 ...
 *
 * @method     ChildLocationQuery leftJoinCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the Category relation
 * @method     ChildLocationQuery rightJoinCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Category relation
 * @method     ChildLocationQuery innerJoinCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the Category relation
 *
 * @method     ChildLocationQuery joinWithCategory($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Category relation
 *
 * @method     ChildLocationQuery leftJoinWithCategory() Adds a LEFT JOIN clause and with to the query using the Category relation
 * @method     ChildLocationQuery rightJoinWithCategory() Adds a RIGHT JOIN clause and with to the query using the Category relation
 * @method     ChildLocationQuery innerJoinWithCategory() Adds a INNER JOIN clause and with to the query using the Category relation
 *
 * @method     ChildLocationQuery leftJoinFacility($relationAlias = null) Adds a LEFT JOIN clause to the query using the Facility relation
 * @method     ChildLocationQuery rightJoinFacility($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Facility relation
 * @method     ChildLocationQuery innerJoinFacility($relationAlias = null) Adds a INNER JOIN clause to the query using the Facility relation
 *
 * @method     ChildLocationQuery joinWithFacility($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Facility relation
 *
 * @method     ChildLocationQuery leftJoinWithFacility() Adds a LEFT JOIN clause and with to the query using the Facility relation
 * @method     ChildLocationQuery rightJoinWithFacility() Adds a RIGHT JOIN clause and with to the query using the Facility relation
 * @method     ChildLocationQuery innerJoinWithFacility() Adds a INNER JOIN clause and with to the query using the Facility relation
 *
 ...
 *
 * @method     \TheFarm\Models\CategoryQuery|\TheFarm\Models\FacilityQuery|\TheFarm\Models\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildLocation findOneByLocation(string $location) Return the first ChildLocation filtered by the location column *
 ...
 * @method     ChildLocation requireOneByLocation(string $location) Return the first ChildLocation filtered by the location column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildLocation[]|ObjectCollection findByLocation(string $location) Return ChildLocation objects filtered by the location column
...
abstract class LocationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \TheFarm\Models\Base\LocationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\TheFarm\\Models\\Location', $modelAlias = null)
    {
    ...
    public function filterByLocation($location = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LocationTableMap::COL_LOCATION, $location, $comparison);
    }
    ...
    public function filterByCategory($category, $comparison = null)
    {
        if ($category instanceof \TheFarm\Models\Category) {
            return $this
                ->addUsingAlias(LocationTableMap::COL_LOCATION_ID, $category->getLocationId(), $comparison);
     ...
     *
     * @param \TheFarm\Models\Facility|ObjectCollection $facility the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildLocationQuery The current query, for fluid interface
     */
    public function filterByFacility($facility, $comparison = null)
    {
        if ($facility instanceof \TheFarm\Models\Facility) {
            return $this
                ->addUsingAlias(LocationTableMap::COL_LOCATION_ID, $facility->getLocationId(), $comparison);
        } elseif ($facility instanceof ObjectCollection) {
            return $this
                ->useFacilityQuery()
                ->filterByPrimaryKeys($facility->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \TheFarm\Models\User) {
            return $this
                ->addUsingAlias(LocationTableMap::COL_LOCATION_ID, $user->getLocationId(), $comparison);
