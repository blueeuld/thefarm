...
abstract class Booking implements ActiveRecordInterface
{
     ...
     * @return ObjectCollection|ChildEvent[] List of ChildEvent objects
     */
    public function getEventsJoinItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEventQuery::create(null, $criteria);
    ...
    public function setBookingForms(Collection $bookingForms, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingFormsToDelete as $bookingFormRemoved) {
            $bookingFormRemoved->setBooking(null);
        }
     ...
     * @return ObjectCollection|ChildBookingForm[] List of ChildBookingForm objects
     */
    public function getBookingFormsJoinForm(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBookingFormQuery::create(null, $criteria);
