...
/**
 * Base class that represents a row from the 'tf_user_work_plan_day' table.
 *
 *
 *
 * @package    propel.generator.TheFarm.Models.Base
 */
abstract class UserWorkPlanDay implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\UserWorkPlanDayTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\UserWorkPlanDay object.
     */
    ...
    /**
     * Compares this with another <code>UserWorkPlanDay</code> instance.  If
     * <code>obj</code> is an instance of <code>UserWorkPlanDay</code>, delegates to
     * <code>equals(UserWorkPlanDay)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserWorkPlanDay The current object, for fluid interface
     */
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[UserWorkPlanDayTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = UserWorkPlanDayTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\UserWorkPlanDay'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(UserWorkPlanDayTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildUserWorkPlanDayQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserWorkPlanDay::setDeleted()
     * @see UserWorkPlanDay::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserWorkPlanDayQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserWorkPlanDayTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO tf_user_work_plan_day (%s) VALUES (%s)',
    ...
    {
        $pos = UserWorkPlanDayTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\UserWorkPlanDay
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\UserWorkPlanDay The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\UserWorkPlanDay (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\UserWorkPlanDay Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UserWorkPlanDayTableMap::DEFAULT_STRING_FORMAT);
    }
