 ...
 */
abstract class BookingForms implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\BookingFormsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\BookingForms object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>BookingForms</code> instance.  If
     * <code>obj</code> is an instance of <code>BookingForms</code>, delegates to
     * <code>equals(BookingForms)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BookingForms The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\BookingForms The current object (for fluent API support)
     */
    public function setBookingId($v)
    {
        ...
        if ($this->booking_id !== $v) {
            $this->booking_id = $v;
            $this->modifiedColumns[BookingFormsTableMap::COL_BOOKING_ID] = true;
        }
    ...
    public function setFormId($v)
    {
        ...
        if ($this->form_id !== $v) {
            $this->form_id = $v;
            $this->modifiedColumns[BookingFormsTableMap::COL_FORM_ID] = true;
        }
    ...
    public function setRequired($v)
    {
        ...
        if ($this->required !== $v) {
            $this->required = $v;
            $this->modifiedColumns[BookingFormsTableMap::COL_REQUIRED] = true;
        }
    ...
    public function setSubmitted($v)
    {
        ...
        if ($this->submitted !== $v) {
            $this->submitted = $v;
            $this->modifiedColumns[BookingFormsTableMap::COL_SUBMITTED] = true;
        }
    ...
    public function setNotifyUserOnSubmit($v)
    {
        ...
        if ($this->notify_user_on_submit !== $v) {
            ...
            $this->modifiedColumns[BookingFormsTableMap::COL_NOTIFY_USER_ON_SUBMIT] = true;
        }
    ...
    public function setSubmittedDate($v)
    {
        ...
        if ($this->submitted_date !== $v) {
            ...
            $this->modifiedColumns[BookingFormsTableMap::COL_SUBMITTED_DATE] = true;
        }
    ...
    public function setCompletedBy($v)
    {
        ...
        if ($this->completed_by !== $v) {
            $this->completed_by = $v;
            $this->modifiedColumns[BookingFormsTableMap::COL_COMPLETED_BY] = true;
        }
    ...
    public function setCompletedDate($v)
    {
        ...
        if ($this->completed_date !== $v) {
            ...
            $this->modifiedColumns[BookingFormsTableMap::COL_COMPLETED_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BookingFormsTableMap::translateFieldName('BookingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->booking_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BookingFormsTableMap::translateFieldName('FormId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->form_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BookingFormsTableMap::translateFieldName('Required', TableMap::TYPE_PHPNAME, $indexType)];
            $this->required = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BookingFormsTableMap::translateFieldName('Submitted', TableMap::TYPE_PHPNAME, $indexType)];
            $this->submitted = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BookingFormsTableMap::translateFieldName('NotifyUserOnSubmit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notify_user_on_submit = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BookingFormsTableMap::translateFieldName('SubmittedDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->submitted_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : BookingFormsTableMap::translateFieldName('CompletedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->completed_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : BookingFormsTableMap::translateFieldName('CompletedDate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = BookingFormsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\BookingForms'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBookingFormsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BookingForms::setDeleted()
     * @see BookingForms::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBookingFormsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BookingFormsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookingFormsTableMap::COL_BOOKING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'booking_id';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_FORM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'form_id';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_REQUIRED)) {
            $modifiedColumns[':p' . $index++]  = 'required';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_SUBMITTED)) {
            $modifiedColumns[':p' . $index++]  = 'submitted';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_NOTIFY_USER_ON_SUBMIT)) {
            $modifiedColumns[':p' . $index++]  = 'notify_user_on_submit';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_SUBMITTED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'submitted_date';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_COMPLETED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'completed_by';
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_COMPLETED_DATE)) {
    ...
    {
        $pos = BookingFormsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['BookingForms'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BookingForms'][$this->hashCode()] = true;
        $keys = BookingFormsTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\BookingForms
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\BookingForms The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookingFormsTableMap::COL_BOOKING_ID)) {
            $criteria->add(BookingFormsTableMap::COL_BOOKING_ID, $this->booking_id);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_FORM_ID)) {
            $criteria->add(BookingFormsTableMap::COL_FORM_ID, $this->form_id);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_REQUIRED)) {
            $criteria->add(BookingFormsTableMap::COL_REQUIRED, $this->required);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_SUBMITTED)) {
            $criteria->add(BookingFormsTableMap::COL_SUBMITTED, $this->submitted);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_NOTIFY_USER_ON_SUBMIT)) {
            $criteria->add(BookingFormsTableMap::COL_NOTIFY_USER_ON_SUBMIT, $this->notify_user_on_submit);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_SUBMITTED_DATE)) {
            $criteria->add(BookingFormsTableMap::COL_SUBMITTED_DATE, $this->submitted_date);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_COMPLETED_BY)) {
            $criteria->add(BookingFormsTableMap::COL_COMPLETED_BY, $this->completed_by);
        }
        if ($this->isColumnModified(BookingFormsTableMap::COL_COMPLETED_DATE)) {
            $criteria->add(BookingFormsTableMap::COL_COMPLETED_DATE, $this->completed_date);
        }
    ...
    {
        $criteria = ChildBookingFormsQuery::create();
        $criteria->add(BookingFormsTableMap::COL_BOOKING_ID, $this->booking_id);
        $criteria->add(BookingFormsTableMap::COL_FORM_ID, $this->form_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\BookingForms (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\BookingForms Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(BookingFormsTableMap::DEFAULT_STRING_FORMAT);
    }
