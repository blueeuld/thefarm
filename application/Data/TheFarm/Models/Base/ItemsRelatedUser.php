 ...
 */
abstract class ItemsRelatedUser implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\ItemsRelatedUserTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\ItemsRelatedUser object.
     */
    ...
    /**
     * Compares this with another <code>ItemsRelatedUser</code> instance.  If
     * <code>obj</code> is an instance of <code>ItemsRelatedUser</code>, delegates to
     * <code>equals(ItemsRelatedUser)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ItemsRelatedUser The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ItemsRelatedUserTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ItemsRelatedUserTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\ItemsRelatedUser'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildItemsRelatedUserQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ItemsRelatedUser::setDeleted()
     * @see ItemsRelatedUser::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildItemsRelatedUserQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ItemsRelatedUserTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = ItemsRelatedUserTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ItemsRelatedUser'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ItemsRelatedUser'][$this->hashCode()] = true;
        $keys = ItemsRelatedUserTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\ItemsRelatedUser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\ItemsRelatedUser The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation tf_items_related_users_fk_b49f13 to table tf_items
    ...
    {
        return (null === $this->getItemId()) && (null === $this->getContactId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\ItemsRelatedUser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\ItemsRelatedUser Clone of current object.
     * @throws PropelException
     */
    ...
    public function getContact(ConnectionInterface $con = null)
    {
        if ($this->aContact === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContact->addItemsRelatedUsers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ItemsRelatedUserTableMap::DEFAULT_STRING_FORMAT);
    }
