 ...
 */
abstract class Contacts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\ContactsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Contacts object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Contacts</code> instance.  If
     * <code>obj</code> is an instance of <code>Contacts</code>, delegates to
     * <code>equals(Contacts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Contacts The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\Contacts The current object (for fluent API support)
     */
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[ContactsTableMap::COL_CONTACT_ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[ContactsTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[ContactsTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setMiddleName($v)
    {
        ...
        if ($this->middle_name !== $v) {
            $this->middle_name = $v;
            $this->modifiedColumns[ContactsTableMap::COL_MIDDLE_NAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[ContactsTableMap::COL_EMAIL] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ContactsTableMap::COL_TITLE] = true;
        }
    ...
    public function setDateJoined($v)
    {
        ...
        if ($this->date_joined !== null || $dt !== null) {
            if ($this->date_joined === null || $dt === null || $dt->format("Y-m-d") !== $this->date_joined->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ContactsTableMap::COL_DATE_JOINED] = true;
            }
    ...
    public function setAvatar($v)
    {
        ...
        if ($this->avatar !== $v) {
            $this->avatar = $v;
            $this->modifiedColumns[ContactsTableMap::COL_AVATAR] = true;
        }
    ...
    public function setCivilStatus($v)
    {
        ...
        if ($this->civil_status !== $v) {
            $this->civil_status = $v;
            $this->modifiedColumns[ContactsTableMap::COL_CIVIL_STATUS] = true;
        }
    ...
    public function setNationality($v)
    {
        ...
        if ($this->nationality !== $v) {
            $this->nationality = $v;
            $this->modifiedColumns[ContactsTableMap::COL_NATIONALITY] = true;
        }
    ...
    public function setCountryDominicile($v)
    {
        ...
        if ($this->country_dominicile !== $v) {
            ...
            $this->modifiedColumns[ContactsTableMap::COL_COUNTRY_DOMINICILE] = true;
        }
    ...
    public function setEtnicOrigin($v)
    {
        ...
        if ($this->etnic_origin !== $v) {
            $this->etnic_origin = $v;
            $this->modifiedColumns[ContactsTableMap::COL_ETNIC_ORIGIN] = true;
        }
    ...
    public function setDob($v)
    {
        ...
        if ($this->dob !== null || $dt !== null) {
            if ($this->dob === null || $dt === null || $dt->format("Y-m-d") !== $this->dob->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ContactsTableMap::COL_DOB] = true;
            }
        } // if either are not null
    ...
    public function setPlaceOfBirth($v)
    {
        ...
        if ($this->place_of_birth !== $v) {
            ...
            $this->modifiedColumns[ContactsTableMap::COL_PLACE_OF_BIRTH] = true;
        }
    ...
    public function setAge($v)
    {
        ...
        if ($this->age !== $v) {
            $this->age = $v;
            $this->modifiedColumns[ContactsTableMap::COL_AGE] = true;
        }
    ...
    public function setGender($v)
    {
        ...
        if ($this->gender !== $v) {
            $this->gender = $v;
            $this->modifiedColumns[ContactsTableMap::COL_GENDER] = true;
        }
    ...
    public function setHeight($v)
    {
        ...
        if ($this->height !== $v) {
            $this->height = $v;
            $this->modifiedColumns[ContactsTableMap::COL_HEIGHT] = true;
        }
    ...
    public function setWeight($v)
    {
        ...
        if ($this->weight !== $v) {
            $this->weight = $v;
            $this->modifiedColumns[ContactsTableMap::COL_WEIGHT] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[ContactsTableMap::COL_PHONE] = true;
        }
    ...
    public function setPositionCd($v)
    {
        ...
        if ($this->position_cd !== $v) {
            $this->position_cd = $v;
            $this->modifiedColumns[ContactsTableMap::COL_POSITION_CD] = true;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[ContactsTableMap::COL_IS_ACTIVE] = true;
        }
    ...
    public function setVerificationKey($v)
    {
        ...
        if ($this->verification_key !== $v) {
            ...
            $this->modifiedColumns[ContactsTableMap::COL_VERIFICATION_KEY] = true;
        }
    ...
    public function setVerified($v)
    {
        ...
        if ($this->verified !== $v) {
            $this->verified = $v;
            $this->modifiedColumns[ContactsTableMap::COL_VERIFIED] = true;
        }
    ...
    public function setNickname($v)
    {
        ...
        if ($this->nickname !== $v) {
            $this->nickname = $v;
            $this->modifiedColumns[ContactsTableMap::COL_NICKNAME] = true;
        }
    ...
    public function setBio($v)
    {
        ...
        if ($this->bio !== $v) {
            $this->bio = $v;
            $this->modifiedColumns[ContactsTableMap::COL_BIO] = true;
        }
    ...
    public function setApproved($v)
    {
        ...
        if ($this->approved !== $v) {
            $this->approved = $v;
            $this->modifiedColumns[ContactsTableMap::COL_APPROVED] = true;
        }
    ...
    public function setActivationCode($v)
    {
        ...
        if ($this->activation_code !== $v) {
            ...
            $this->modifiedColumns[ContactsTableMap::COL_ACTIVATION_CODE] = true;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[ContactsTableMap::COL_ACTIVE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContactsTableMap::translateFieldName('ContactId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContactsTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContactsTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ContactsTableMap::translateFieldName('MiddleName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->middle_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ContactsTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ContactsTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ContactsTableMap::translateFieldName('DateJoined', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_joined = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ContactsTableMap::translateFieldName('Avatar', TableMap::TYPE_PHPNAME, $indexType)];
            $this->avatar = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ContactsTableMap::translateFieldName('CivilStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->civil_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ContactsTableMap::translateFieldName('Nationality', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nationality = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ContactsTableMap::translateFieldName('CountryDominicile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country_dominicile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ContactsTableMap::translateFieldName('EtnicOrigin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->etnic_origin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ContactsTableMap::translateFieldName('Dob', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->dob = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ContactsTableMap::translateFieldName('PlaceOfBirth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->place_of_birth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ContactsTableMap::translateFieldName('Age', TableMap::TYPE_PHPNAME, $indexType)];
            $this->age = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ContactsTableMap::translateFieldName('Gender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gender = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ContactsTableMap::translateFieldName('Height', TableMap::TYPE_PHPNAME, $indexType)];
            $this->height = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ContactsTableMap::translateFieldName('Weight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ContactsTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ContactsTableMap::translateFieldName('PositionCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : ContactsTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : ContactsTableMap::translateFieldName('VerificationKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verification_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : ContactsTableMap::translateFieldName('Verified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verified = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : ContactsTableMap::translateFieldName('Nickname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nickname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : ContactsTableMap::translateFieldName('Bio', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bio = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : ContactsTableMap::translateFieldName('Approved', TableMap::TYPE_PHPNAME, $indexType)];
            $this->approved = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : ContactsTableMap::translateFieldName('ActivationCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activation_code = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : ContactsTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 28; // 28 = ContactsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Contacts'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildContactsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Contacts::setDeleted()
     * @see Contacts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildContactsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContactsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->singleUsers !== null) {
                if (!$this->singleUsers->isDeleted() && ($this->singleUsers->isNew() || $this->singleUsers->isModified())) {
                    $affectedRows += $this->singleUsers->save($con);
                }
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContactsTableMap::COL_CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'contact_id';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'last_name';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_MIDDLE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'middle_name';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_DATE_JOINED)) {
            $modifiedColumns[':p' . $index++]  = 'date_joined';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_AVATAR)) {
            $modifiedColumns[':p' . $index++]  = 'avatar';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_CIVIL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'civil_status';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_NATIONALITY)) {
            $modifiedColumns[':p' . $index++]  = 'nationality';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_COUNTRY_DOMINICILE)) {
            $modifiedColumns[':p' . $index++]  = 'country_dominicile';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ETNIC_ORIGIN)) {
            $modifiedColumns[':p' . $index++]  = 'etnic_origin';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_DOB)) {
            $modifiedColumns[':p' . $index++]  = 'dob';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_PLACE_OF_BIRTH)) {
            $modifiedColumns[':p' . $index++]  = 'place_of_birth';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_AGE)) {
            $modifiedColumns[':p' . $index++]  = 'age';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_GENDER)) {
            $modifiedColumns[':p' . $index++]  = 'gender';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_HEIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'height';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_WEIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'weight';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_POSITION_CD)) {
            $modifiedColumns[':p' . $index++]  = 'position_cd';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'is_active';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_VERIFICATION_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'verification_key';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_VERIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'verified';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_NICKNAME)) {
            $modifiedColumns[':p' . $index++]  = 'nickname';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_BIO)) {
            $modifiedColumns[':p' . $index++]  = 'bio';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_APPROVED)) {
            $modifiedColumns[':p' . $index++]  = 'approved';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ACTIVATION_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'activation_code';
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ACTIVE)) {
    ...
    {
        $pos = ContactsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Contacts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Contacts'][$this->hashCode()] = true;
        $keys = ContactsTableMap::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->singleUsers) {
                ...
                $result[$key] = $this->singleUsers->toArray($keyType, $includeLazyLoadColumns, $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Contacts
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Contacts The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContactsTableMap::COL_CONTACT_ID)) {
            $criteria->add(ContactsTableMap::COL_CONTACT_ID, $this->contact_id);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_FIRST_NAME)) {
            $criteria->add(ContactsTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_LAST_NAME)) {
            $criteria->add(ContactsTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_MIDDLE_NAME)) {
            $criteria->add(ContactsTableMap::COL_MIDDLE_NAME, $this->middle_name);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_EMAIL)) {
            $criteria->add(ContactsTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_TITLE)) {
            $criteria->add(ContactsTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_DATE_JOINED)) {
            $criteria->add(ContactsTableMap::COL_DATE_JOINED, $this->date_joined);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_AVATAR)) {
            $criteria->add(ContactsTableMap::COL_AVATAR, $this->avatar);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_CIVIL_STATUS)) {
            $criteria->add(ContactsTableMap::COL_CIVIL_STATUS, $this->civil_status);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_NATIONALITY)) {
            $criteria->add(ContactsTableMap::COL_NATIONALITY, $this->nationality);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_COUNTRY_DOMINICILE)) {
            $criteria->add(ContactsTableMap::COL_COUNTRY_DOMINICILE, $this->country_dominicile);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ETNIC_ORIGIN)) {
            $criteria->add(ContactsTableMap::COL_ETNIC_ORIGIN, $this->etnic_origin);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_DOB)) {
            $criteria->add(ContactsTableMap::COL_DOB, $this->dob);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_PLACE_OF_BIRTH)) {
            $criteria->add(ContactsTableMap::COL_PLACE_OF_BIRTH, $this->place_of_birth);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_AGE)) {
            $criteria->add(ContactsTableMap::COL_AGE, $this->age);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_GENDER)) {
            $criteria->add(ContactsTableMap::COL_GENDER, $this->gender);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_HEIGHT)) {
            $criteria->add(ContactsTableMap::COL_HEIGHT, $this->height);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_WEIGHT)) {
            $criteria->add(ContactsTableMap::COL_WEIGHT, $this->weight);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_PHONE)) {
            $criteria->add(ContactsTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_POSITION_CD)) {
            $criteria->add(ContactsTableMap::COL_POSITION_CD, $this->position_cd);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_IS_ACTIVE)) {
            $criteria->add(ContactsTableMap::COL_IS_ACTIVE, $this->is_active);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_VERIFICATION_KEY)) {
            $criteria->add(ContactsTableMap::COL_VERIFICATION_KEY, $this->verification_key);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_VERIFIED)) {
            $criteria->add(ContactsTableMap::COL_VERIFIED, $this->verified);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_NICKNAME)) {
            $criteria->add(ContactsTableMap::COL_NICKNAME, $this->nickname);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_BIO)) {
            $criteria->add(ContactsTableMap::COL_BIO, $this->bio);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_APPROVED)) {
            $criteria->add(ContactsTableMap::COL_APPROVED, $this->approved);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ACTIVATION_CODE)) {
            $criteria->add(ContactsTableMap::COL_ACTIVATION_CODE, $this->activation_code);
        }
        if ($this->isColumnModified(ContactsTableMap::COL_ACTIVE)) {
            $criteria->add(ContactsTableMap::COL_ACTIVE, $this->active);
        }
    ...
    {
        $criteria = ChildContactsQuery::create();
        $criteria->add(ContactsTableMap::COL_CONTACT_ID, $this->contact_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Contacts (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy) {
            ...
            $relObj = $this->getUsers();
            if ($relObj) {
                $copyObj->setUsers($relObj->copy($deepCopy));
            }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Contacts Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPosition(ConnectionInterface $con = null)
    {
        if ($this->aPosition === null && (($this->position_cd !== "" && $this->position_cd !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPosition->addContactss($this);
             */
        }
     ...
     * If this ChildContacts is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildContacts The current object (for fluent API support)
     */
    public function setBookingEventUserss(Collection $bookingEventUserss, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingEventUserssToDelete as $bookingEventUsersRemoved) {
            $bookingEventUsersRemoved->setContacts(null);
        }
    ...
    protected function doAddBookingEventUsers(ChildBookingEventUsers $bookingEventUsers)
    {
        ...
        $bookingEventUsers->setContacts($this);
    }
    ...
    public function removeBookingEventUsers(ChildBookingEventUsers $bookingEventUsers)
    {
        if ($this->getBookingEventUserss()->contains($bookingEventUsers)) {
            ...
            $bookingEventUsers->setContacts(null);
        }
        ...
        if (null === $this->collBookingEventssRelatedByAuthorId || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBookingEventssRelatedByAuthorId) {
                ...
                $collBookingEventssRelatedByAuthorId = ChildBookingEventsQuery::create(null, $criteria)
                    ->filterByContactsRelatedByAuthorId($this)
                    ->find($con);
    ...
    public function setBookingEventssRelatedByAuthorId(Collection $bookingEventssRelatedByAuthorId, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingEventssRelatedByAuthorIdToDelete as $bookingEventsRelatedByAuthorIdRemoved) {
            $bookingEventsRelatedByAuthorIdRemoved->setContactsRelatedByAuthorId(null);
        }
    ...
    protected function doAddBookingEventsRelatedByAuthorId(ChildBookingEvents $bookingEventsRelatedByAuthorId)
    {
        ...
        $bookingEventsRelatedByAuthorId->setContactsRelatedByAuthorId($this);
    }
    ...
    public function removeBookingEventsRelatedByAuthorId(ChildBookingEvents $bookingEventsRelatedByAuthorId)
    {
        if ($this->getBookingEventssRelatedByAuthorId()->contains($bookingEventsRelatedByAuthorId)) {
            ...
            $bookingEventsRelatedByAuthorId->setContactsRelatedByAuthorId(null);
        }
        ...
        if (null === $this->collBookingEventssRelatedByCalledBy || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBookingEventssRelatedByCalledBy) {
                ...
                $collBookingEventssRelatedByCalledBy = ChildBookingEventsQuery::create(null, $criteria)
                    ->filterByContactsRelatedByCalledBy($this)
                    ->find($con);
    ...
    public function setBookingEventssRelatedByCalledBy(Collection $bookingEventssRelatedByCalledBy, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingEventssRelatedByCalledByToDelete as $bookingEventsRelatedByCalledByRemoved) {
            $bookingEventsRelatedByCalledByRemoved->setContactsRelatedByCalledBy(null);
        }
    ...
    protected function doAddBookingEventsRelatedByCalledBy(ChildBookingEvents $bookingEventsRelatedByCalledBy)
    {
        ...
        $bookingEventsRelatedByCalledBy->setContactsRelatedByCalledBy($this);
    }
    ...
    public function removeBookingEventsRelatedByCalledBy(ChildBookingEvents $bookingEventsRelatedByCalledBy)
    {
        if ($this->getBookingEventssRelatedByCalledBy()->contains($bookingEventsRelatedByCalledBy)) {
            ...
            $bookingEventsRelatedByCalledBy->setContactsRelatedByCalledBy(null);
        }
        ...
        if (null === $this->collBookingEventssRelatedByCancelledBy || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBookingEventssRelatedByCancelledBy) {
                ...
                $collBookingEventssRelatedByCancelledBy = ChildBookingEventsQuery::create(null, $criteria)
                    ->filterByContactsRelatedByCancelledBy($this)
                    ->find($con);
    ...
    public function setBookingEventssRelatedByCancelledBy(Collection $bookingEventssRelatedByCancelledBy, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingEventssRelatedByCancelledByToDelete as $bookingEventsRelatedByCancelledByRemoved) {
            $bookingEventsRelatedByCancelledByRemoved->setContactsRelatedByCancelledBy(null);
        }
    ...
    protected function doAddBookingEventsRelatedByCancelledBy(ChildBookingEvents $bookingEventsRelatedByCancelledBy)
    {
        ...
        $bookingEventsRelatedByCancelledBy->setContactsRelatedByCancelledBy($this);
    }
    ...
    public function removeBookingEventsRelatedByCancelledBy(ChildBookingEvents $bookingEventsRelatedByCancelledBy)
    {
        if ($this->getBookingEventssRelatedByCancelledBy()->contains($bookingEventsRelatedByCancelledBy)) {
            ...
            $bookingEventsRelatedByCancelledBy->setContactsRelatedByCancelledBy(null);
        }
        ...
        if (null === $this->collBookingEventssRelatedByDeletedBy || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBookingEventssRelatedByDeletedBy) {
                ...
                $collBookingEventssRelatedByDeletedBy = ChildBookingEventsQuery::create(null, $criteria)
                    ->filterByContactsRelatedByDeletedBy($this)
                    ->find($con);
    ...
    public function setBookingEventssRelatedByDeletedBy(Collection $bookingEventssRelatedByDeletedBy, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingEventssRelatedByDeletedByToDelete as $bookingEventsRelatedByDeletedByRemoved) {
            $bookingEventsRelatedByDeletedByRemoved->setContactsRelatedByDeletedBy(null);
        }
    ...
    protected function doAddBookingEventsRelatedByDeletedBy(ChildBookingEvents $bookingEventsRelatedByDeletedBy)
    {
        ...
        $bookingEventsRelatedByDeletedBy->setContactsRelatedByDeletedBy($this);
    }
    ...
    public function removeBookingEventsRelatedByDeletedBy(ChildBookingEvents $bookingEventsRelatedByDeletedBy)
    {
        if ($this->getBookingEventssRelatedByDeletedBy()->contains($bookingEventsRelatedByDeletedBy)) {
            ...
            $bookingEventsRelatedByDeletedBy->setContactsRelatedByDeletedBy(null);
        }
    ...
    public function setBookingssRelatedByAuthorId(Collection $bookingssRelatedByAuthorId, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingssRelatedByAuthorIdToDelete as $bookingsRelatedByAuthorIdRemoved) {
            $bookingsRelatedByAuthorIdRemoved->setContactsRelatedByAuthorId(null);
        }
    ...
    protected function doAddBookingsRelatedByAuthorId(ChildBookings $bookingsRelatedByAuthorId)
    {
        ...
        $bookingsRelatedByAuthorId->setContactsRelatedByAuthorId($this);
    }
    ...
    public function removeBookingsRelatedByAuthorId(ChildBookings $bookingsRelatedByAuthorId)
    {
        if ($this->getBookingssRelatedByAuthorId()->contains($bookingsRelatedByAuthorId)) {
            ...
            $bookingsRelatedByAuthorId->setContactsRelatedByAuthorId(null);
        }
        ...
        if (null === $this->collBookingssRelatedByGuestId || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBookingssRelatedByGuestId) {
                ...
                $collBookingssRelatedByGuestId = ChildBookingsQuery::create(null, $criteria)
                    ->filterByContactsRelatedByGuestId($this)
                    ->find($con);
    ...
    public function setBookingssRelatedByGuestId(Collection $bookingssRelatedByGuestId, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingssRelatedByGuestIdToDelete as $bookingsRelatedByGuestIdRemoved) {
            $bookingsRelatedByGuestIdRemoved->setContactsRelatedByGuestId(null);
        }
    ...
    protected function doAddBookingsRelatedByGuestId(ChildBookings $bookingsRelatedByGuestId)
    {
        ...
        $bookingsRelatedByGuestId->setContactsRelatedByGuestId($this);
    }
    ...
    public function removeBookingsRelatedByGuestId(ChildBookings $bookingsRelatedByGuestId)
    {
        if ($this->getBookingssRelatedByGuestId()->contains($bookingsRelatedByGuestId)) {
            ...
            $bookingsRelatedByGuestId->setContactsRelatedByGuestId(null);
        }
    ...
    public function setItemsRelatedUserss(Collection $itemsRelatedUserss, ConnectionInterface $con = null)
    {
        ...
        foreach ($itemsRelatedUserssToDelete as $itemsRelatedUsersRemoved) {
            $itemsRelatedUsersRemoved->setContacts(null);
        }
    ...
    protected function doAddItemsRelatedUsers(ChildItemsRelatedUsers $itemsRelatedUsers)
    {
        ...
        $itemsRelatedUsers->setContacts($this);
    }
    ...
    public function removeItemsRelatedUsers(ChildItemsRelatedUsers $itemsRelatedUsers)
    {
        if ($this->getItemsRelatedUserss()->contains($itemsRelatedUsers)) {
            ...
            $itemsRelatedUsers->setContacts(null);
        }
    ...
    public function getUsers(ConnectionInterface $con = null)
    {
        ...
        if ($this->singleUsers === null && !$this->isNew()) {
            $this->singleUsers = ChildUsersQuery::create()->findPk($this->getPrimaryKey(), $con);
        }
    ...
    public function setUsers(ChildUsers $v = null)
    {
        ...
        if ($v !== null && $v->getContacts(null, false) === null) {
            $v->setContacts($this);
        }
    ...
    {
        if (null !== $this->aPosition) {
            $this->aPosition->removeContacts($this);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            ...
            if ($this->singleUsers) {
                $this->singleUsers->clearAllReferences($deep);
            }
        } // if ($deep)
    ...
    {
        return (string) $this->exportTo(ContactsTableMap::DEFAULT_STRING_FORMAT);
    }
