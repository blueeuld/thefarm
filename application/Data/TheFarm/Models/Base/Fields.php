 ...
 */
abstract class Fields implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\FieldsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Fields object.
     */
    ...
    /**
     * Compares this with another <code>Fields</code> instance.  If
     * <code>obj</code> is an instance of <code>Fields</code>, delegates to
     * <code>equals(Fields)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Fields The current object, for fluid interface
     */
     ...
     * @return $this|\TheFarm\Models\Fields The current object (for fluent API support)
     */
    public function setFieldId($v)
    {
        ...
        if ($this->field_id !== $v) {
            $this->field_id = $v;
            $this->modifiedColumns[FieldsTableMap::COL_FIELD_ID] = true;
        }
    ...
    public function setFieldName($v)
    {
        ...
        if ($this->field_name !== $v) {
            $this->field_name = $v;
            $this->modifiedColumns[FieldsTableMap::COL_FIELD_NAME] = true;
        }
    ...
    public function setFieldLabel($v)
    {
        ...
        if ($this->field_label !== $v) {
            $this->field_label = $v;
            $this->modifiedColumns[FieldsTableMap::COL_FIELD_LABEL] = true;
        }
    ...
    public function setFieldType($v)
    {
        ...
        if ($this->field_type !== $v) {
            $this->field_type = $v;
            $this->modifiedColumns[FieldsTableMap::COL_FIELD_TYPE] = true;
        }
    ...
    public function setSettings($v)
    {
        ...
        if ($this->settings !== $v) {
            $this->settings = $v;
            $this->modifiedColumns[FieldsTableMap::COL_SETTINGS] = true;
        }
    ...
    public function setRequired($v)
    {
        ...
        if ($this->required !== $v) {
            $this->required = $v;
            $this->modifiedColumns[FieldsTableMap::COL_REQUIRED] = true;
        }
    ...
    public function setEntryDate($v)
    {
        ...
        if ($this->entry_date !== $v) {
            $this->entry_date = $v;
            $this->modifiedColumns[FieldsTableMap::COL_ENTRY_DATE] = true;
        }
    ...
    public function setEditDate($v)
    {
        ...
        if ($this->edit_date !== $v) {
            $this->edit_date = $v;
            $this->modifiedColumns[FieldsTableMap::COL_EDIT_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FieldsTableMap::translateFieldName('FieldId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->field_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FieldsTableMap::translateFieldName('FieldName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->field_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FieldsTableMap::translateFieldName('FieldLabel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->field_label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FieldsTableMap::translateFieldName('FieldType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->field_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FieldsTableMap::translateFieldName('Settings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->settings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FieldsTableMap::translateFieldName('Required', TableMap::TYPE_PHPNAME, $indexType)];
            $this->required = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FieldsTableMap::translateFieldName('EntryDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entry_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FieldsTableMap::translateFieldName('EditDate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = FieldsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Fields'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFieldsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Fields::setDeleted()
     * @see Fields::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFieldsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FieldsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->formEntriessScheduledForDeletion !== null) {
                if (!$this->formEntriessScheduledForDeletion->isEmpty()) {
                    \TheFarm\Models\FormEntriesQuery::create()
                        ->filterByPrimaryKeys($this->formEntriessScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'field_id';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'field_name';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'field_label';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'field_type';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_SETTINGS)) {
            $modifiedColumns[':p' . $index++]  = 'settings';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_REQUIRED)) {
            $modifiedColumns[':p' . $index++]  = 'required';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_ENTRY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'entry_date';
        }
        if ($this->isColumnModified(FieldsTableMap::COL_EDIT_DATE)) {
    ...
    {
        $pos = FieldsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Fields'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Fields'][$this->hashCode()] = true;
        $keys = FieldsTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Fields
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Fields The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_ID)) {
            $criteria->add(FieldsTableMap::COL_FIELD_ID, $this->field_id);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_NAME)) {
            $criteria->add(FieldsTableMap::COL_FIELD_NAME, $this->field_name);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_LABEL)) {
            $criteria->add(FieldsTableMap::COL_FIELD_LABEL, $this->field_label);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_FIELD_TYPE)) {
            $criteria->add(FieldsTableMap::COL_FIELD_TYPE, $this->field_type);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_SETTINGS)) {
            $criteria->add(FieldsTableMap::COL_SETTINGS, $this->settings);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_REQUIRED)) {
            $criteria->add(FieldsTableMap::COL_REQUIRED, $this->required);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_ENTRY_DATE)) {
            $criteria->add(FieldsTableMap::COL_ENTRY_DATE, $this->entry_date);
        }
        if ($this->isColumnModified(FieldsTableMap::COL_EDIT_DATE)) {
            $criteria->add(FieldsTableMap::COL_EDIT_DATE, $this->edit_date);
        }
    ...
    {
        $criteria = ChildFieldsQuery::create();
        $criteria->add(FieldsTableMap::COL_FIELD_ID, $this->field_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Fields (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Fields Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildFields is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildFields The current object (for fluent API support)
     */
    public function setFormEntriess(Collection $formEntriess, ConnectionInterface $con = null)
    {
        ...
        foreach ($formEntriessToDelete as $formEntriesRemoved) {
            $formEntriesRemoved->setFields(null);
        }
    ...
    public function removeFormEntries(ChildFormEntries $formEntries)
    {
        if ($this->getFormEntriess()->contains($formEntries)) {
            ...
            $this->formEntriessScheduledForDeletion[]= clone $formEntries;
            $formEntries->setFields(null);
        }
     ...
     * Otherwise if this Fields is new, it will return
     * an empty collection; or if this Fields has previously
     * been saved, it will retrieve related FormEntriess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Fields.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildFormEntries[] List of ChildFormEntries objects
     */
    public function getFormEntriessJoinBookings(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildFormEntriesQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(FieldsTableMap::DEFAULT_STRING_FORMAT);
    }
