 ...
 */
abstract class BookingEventUser implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\BookingEventUserTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\BookingEventUser object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>BookingEventUser</code> instance.  If
     * <code>obj</code> is an instance of <code>BookingEventUser</code>, delegates to
     * <code>equals(BookingEventUser)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BookingEventUser The current object, for fluid interface
     */
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[BookingEventUserTableMap::COL_EVENT_ID] = true;
        }

        if ($this->aBookingEvent !== null && $this->aBookingEvent->getEventId() !== $v) {
    ...
    public function setStaffId($v)
    {
        ...
        if ($this->staff_id !== $v) {
            $this->staff_id = $v;
            $this->modifiedColumns[BookingEventUserTableMap::COL_STAFF_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBookingEventUserQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BookingEventUser::setDeleted()
     * @see BookingEventUser::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBookingEventUserQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BookingEventUserTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBookingEvent !== null) {
                if ($this->aBookingEvent->isModified() || $this->aBookingEvent->isNew()) {
                    $affectedRows += $this->aBookingEvent->save($con);
                }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookingEventUserTableMap::COL_EVENT_ID)) {
    ...
    {
        $pos = BookingEventUserTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BookingEventUser'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BookingEventUser'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\BookingEventUser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\BookingEventUser The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(BookingEventUserTableMap::DATABASE_NAME);

        if ($this->isColumnModified(BookingEventUserTableMap::COL_EVENT_ID)) {
            $criteria->add(BookingEventUserTableMap::COL_EVENT_ID, $this->event_id);
        }
        if ($this->isColumnModified(BookingEventUserTableMap::COL_STAFF_ID)) {
    ...
    {
        $criteria = ChildBookingEventUserQuery::create();
        $criteria->add(BookingEventUserTableMap::COL_EVENT_ID, $this->event_id);
        $criteria->add(BookingEventUserTableMap::COL_STAFF_ID, $this->staff_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\BookingEventUser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\BookingEventUser Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildBookingEvent object.
     *
     * @param  ChildBookingEvent $v
     * @return $this|\TheFarm\Models\BookingEventUser The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBookingEvent(ChildBookingEvent $v = null)
    {
        if ($v === null) {
            $this->setEventId(0);
        } else {
        ...
        $this->aBookingEvent = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildBookingEvent object, it will not be re-added.
        if ($v !== null) {
            $v->addBookingEventUser($this);
        }
    ...
    /**
     * Get the associated ChildBookingEvent object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildBookingEvent The associated ChildBookingEvent object.
     * @throws PropelException
     */
    public function getBookingEvent(ConnectionInterface $con = null)
    {
        if ($this->aBookingEvent === null && ($this->event_id !== null)) {
            $this->aBookingEvent = ChildBookingEventQuery::create()->findPk($this->event_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBookingEvent->addBookingEventUsers($this);
             */
        }

        return $this->aBookingEvent;
    }
    ...
    public function getContact(ConnectionInterface $con = null)
    {
        if ($this->aContact === null && ($this->staff_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aContact->addBookingEventUsers($this);
             */
        }
    ...
    {
        if (null !== $this->aBookingEvent) {
            $this->aBookingEvent->removeBookingEventUser($this);
        }
        if (null !== $this->aContact) {
            $this->aContact->removeBookingEventUser($this);
        }
        $this->event_id = null;
        $this->staff_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(BookingEventUserTableMap::DEFAULT_STRING_FORMAT);
    }
