...
abstract class Groups implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\GroupsTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Groups object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\TheFarm\Models\Groups The current object (for fluent API support)
     */
    ...
    public function setGroupCd($v)
    {
        ...
        if ($this->group_cd !== $v) {
            $this->group_cd = $v;
            $this->modifiedColumns[GroupsTableMap::COL_GROUP_CD] = true;
        }
    ...
    public function setGroupName($v)
    {
        ...
        if ($this->group_name !== $v) {
            $this->group_name = $v;
            $this->modifiedColumns[GroupsTableMap::COL_GROUP_NAME] = true;
        }
    ...
    public function setDefaultCalendarView($v)
    {
        ...
        if ($this->default_calendar_view !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_DEFAULT_CALENDAR_VIEW] = true;
        }
    ...
    public function setIncludeInProviderList($v)
    {
        ...
        if ($this->include_in_provider_list !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_INCLUDE_IN_PROVIDER_LIST] = true;
        }
    ...
    public function setCanViewOtherProfiles($v)
    {
        ...
        if ($this->can_view_other_profiles !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_OTHER_PROFILES] = true;
        }
    ...
    public function setCanEditOtherProfiles($v)
    {
        ...
        if ($this->can_edit_other_profiles !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_OTHER_PROFILES] = true;
        }
    ...
    public function setCanDeleteServices($v)
    {
        ...
        if ($this->can_delete_services !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_DELETE_SERVICES] = true;
        }
    ...
    public function setCanEditServices($v)
    {
        ...
        if ($this->can_edit_services !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SERVICES] = true;
        }
    ...
    public function setCanAddSchedule($v)
    {
        ...
        if ($this->can_add_schedule !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADD_SCHEDULE] = true;
        }
    ...
    public function setCanAdminGuest($v)
    {
        ...
        if ($this->can_admin_guest !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_GUEST] = true;
        }
    ...
    public function setCanAdminCalendar($v)
    {
        ...
        if ($this->can_admin_calendar !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_CALENDAR] = true;
        }
    ...
    public function setCanAdminProviders($v)
    {
        ...
        if ($this->can_admin_providers !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_PROVIDERS] = true;
        }
    ...
    public function setCanAdminServices($v)
    {
        ...
        if ($this->can_admin_services !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_SERVICES] = true;
        }
    ...
    public function setCanAdminFacilities($v)
    {
        ...
        if ($this->can_admin_facilities !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_FACILITIES] = true;
        }
    ...
    public function setCanAdminActivities($v)
    {
        ...
        if ($this->can_admin_activities !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_ACTIVITIES] = true;
        }
    ...
    public function setCanAdminPackages($v)
    {
        ...
        if ($this->can_admin_packages !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_PACKAGES] = true;
        }
    ...
    public function setCanAdminReports($v)
    {
        ...
        if ($this->can_admin_reports !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ADMIN_REPORTS] = true;
        }
    ...
    public function setLocation($v)
    {
        ...
        if ($this->location !== $v) {
            $this->location = $v;
            $this->modifiedColumns[GroupsTableMap::COL_LOCATION] = true;
        }
    ...
    public function setForms($v)
    {
        ...
        if ($this->forms !== $v) {
            $this->forms = $v;
            $this->modifiedColumns[GroupsTableMap::COL_FORMS] = true;
        }
    ...
    public function setCanViewSchedules1($v)
    {
        ...
        if ($this->can_view_schedules_1 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_1] = true;
        }
    ...
    public function setCanEditSchedules1($v)
    {
        ...
        if ($this->can_edit_schedules_1 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_1] = true;
        }
    ...
    public function setCanViewSchedules2($v)
    {
        ...
        if ($this->can_view_schedules_2 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_2] = true;
        }
    ...
    public function setCanEditSchedules2($v)
    {
        ...
        if ($this->can_edit_schedules_2 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_2] = true;
        }
    ...
    public function setCanViewSchedules3($v)
    {
        ...
        if ($this->can_view_schedules_3 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_3] = true;
        }
    ...
    public function setCanEditSchedules3($v)
    {
        ...
        if ($this->can_edit_schedules_3 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_3] = true;
        }
    ...
    public function setIncludeInAuditList($v)
    {
        ...
        if ($this->include_in_audit_list !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_INCLUDE_IN_AUDIT_LIST] = true;
        }
    ...
    public function setCanEditCompletedForms($v)
    {
        ...
        if ($this->can_edit_completed_forms !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_COMPLETED_FORMS] = true;
        }
    ...
    public function setCanAssignSchedules($v)
    {
        ...
        if ($this->can_assign_schedules !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_ASSIGN_SCHEDULES] = true;
        }
    ...
    public function setCanViewOtherSchedule($v)
    {
        ...
        if ($this->can_view_other_schedule !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_OTHER_SCHEDULE] = true;
        }
    ...
    public function setCanViewSchedules4($v)
    {
        ...
        if ($this->can_view_schedules_4 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_4] = true;
        }
    ...
    public function setCanEditSchedules4($v)
    {
        ...
        if ($this->can_edit_schedules_4 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_4] = true;
        }
    ...
    public function setCanViewSchedules5($v)
    {
        ...
        if ($this->can_view_schedules_5 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_5] = true;
        }
    ...
    public function setCanEditSchedules5($v)
    {
        ...
        if ($this->can_edit_schedules_5 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_5] = true;
        }
    ...
    public function setCanViewSchedules6($v)
    {
        ...
        if ($this->can_view_schedules_6 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_6] = true;
        }
    ...
    public function setCanEditSchedules6($v)
    {
        ...
        if ($this->can_edit_schedules_6 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_6] = true;
        }
    ...
    public function setCanViewSchedules7($v)
    {
        ...
        if ($this->can_view_schedules_7 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_SCHEDULES_7] = true;
        }
    ...
    public function setCanEditSchedules7($v)
    {
        ...
        if ($this->can_edit_schedules_7 !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_EDIT_SCHEDULES_7] = true;
        }
    ...
    public function setCanViewDashboard($v)
    {
        ...
        if ($this->can_view_dashboard !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_DASHBOARD] = true;
        }
    ...
    public function setNotifyOnBookings($v)
    {
        ...
        if ($this->notify_on_bookings !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_NOTIFY_ON_BOOKINGS] = true;
        }
    ...
    public function setCanManageGuestBookings($v)
    {
        ...
        if ($this->can_manage_guest_bookings !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS] = true;
        }
    ...
    public function setCanManageGuestForms($v)
    {
        ...
        if ($this->can_manage_guest_forms !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_MANAGE_GUEST_FORMS] = true;
        }
    ...
    public function setCanViewFinancial($v)
    {
        ...
        if ($this->can_view_financial !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_FINANCIAL] = true;
        }
    ...
    public function setCanViewTodayBookings($v)
    {
        ...
        if ($this->can_view_today_bookings !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_VIEW_TODAY_BOOKINGS] = true;
        }
    ...
    public function setDashboardTop($v)
    {
        ...
        if ($this->dashboard_top !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_DASHBOARD_TOP] = true;
        }
    ...
    public function setDashboardMiddle($v)
    {
        ...
        if ($this->dashboard_middle !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_DASHBOARD_MIDDLE] = true;
        }
    ...
    public function setDashboardBottom($v)
    {
        ...
        if ($this->dashboard_bottom !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_DASHBOARD_BOTTOM] = true;
        }
    ...
    public function setCalendarHeaderRight($v)
    {
        ...
        if ($this->calendar_header_right !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CALENDAR_HEADER_RIGHT] = true;
        }
    ...
    public function setCanManageGuestSettings($v)
    {
        ...
        if ($this->can_manage_guest_settings !== $v) {
            ...
            $this->modifiedColumns[GroupsTableMap::COL_CAN_MANAGE_GUEST_SETTINGS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupsTableMap::translateFieldName('GroupCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupsTableMap::translateFieldName('GroupName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GroupsTableMap::translateFieldName('DefaultCalendarView', TableMap::TYPE_PHPNAME, $indexType)];
            $this->default_calendar_view = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : GroupsTableMap::translateFieldName('IncludeInProviderList', TableMap::TYPE_PHPNAME, $indexType)];
            $this->include_in_provider_list = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : GroupsTableMap::translateFieldName('CanViewOtherProfiles', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_other_profiles = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : GroupsTableMap::translateFieldName('CanEditOtherProfiles', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_other_profiles = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : GroupsTableMap::translateFieldName('CanDeleteServices', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_delete_services = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : GroupsTableMap::translateFieldName('CanEditServices', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_services = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : GroupsTableMap::translateFieldName('CanAddSchedule', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_add_schedule = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : GroupsTableMap::translateFieldName('CanAdminGuest', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_guest = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : GroupsTableMap::translateFieldName('CanAdminCalendar', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_calendar = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : GroupsTableMap::translateFieldName('CanAdminProviders', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_providers = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : GroupsTableMap::translateFieldName('CanAdminServices', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_services = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : GroupsTableMap::translateFieldName('CanAdminFacilities', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_facilities = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : GroupsTableMap::translateFieldName('CanAdminActivities', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_activities = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : GroupsTableMap::translateFieldName('CanAdminPackages', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_packages = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : GroupsTableMap::translateFieldName('CanAdminReports', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_admin_reports = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : GroupsTableMap::translateFieldName('Location', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : GroupsTableMap::translateFieldName('Forms', TableMap::TYPE_PHPNAME, $indexType)];
            $this->forms = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : GroupsTableMap::translateFieldName('IncludeInAuditList', TableMap::TYPE_PHPNAME, $indexType)];
            $this->include_in_audit_list = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : GroupsTableMap::translateFieldName('CanEditCompletedForms', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_completed_forms = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : GroupsTableMap::translateFieldName('CanAssignSchedules', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_assign_schedules = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : GroupsTableMap::translateFieldName('CanViewOtherSchedule', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_other_schedule = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : GroupsTableMap::translateFieldName('CanViewSchedules7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_schedules_7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : GroupsTableMap::translateFieldName('CanEditSchedules7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_edit_schedules_7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : GroupsTableMap::translateFieldName('CanViewDashboard', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_dashboard = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : GroupsTableMap::translateFieldName('NotifyOnBookings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notify_on_bookings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : GroupsTableMap::translateFieldName('CanManageGuestBookings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_manage_guest_bookings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : GroupsTableMap::translateFieldName('CanManageGuestForms', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_manage_guest_forms = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : GroupsTableMap::translateFieldName('CanViewFinancial', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_financial = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : GroupsTableMap::translateFieldName('CanViewTodayBookings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_view_today_bookings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : GroupsTableMap::translateFieldName('DashboardTop', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dashboard_top = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : GroupsTableMap::translateFieldName('DashboardMiddle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dashboard_middle = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : GroupsTableMap::translateFieldName('DashboardBottom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dashboard_bottom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : GroupsTableMap::translateFieldName('CalendarHeaderRight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calendar_header_right = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : GroupsTableMap::translateFieldName('CanManageGuestSettings', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 49; // 49 = GroupsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Groups'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupsTableMap::COL_GROUP_CD)) {
            $modifiedColumns[':p' . $index++]  = 'group_cd';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_GROUP_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'group_name';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DEFAULT_CALENDAR_VIEW)) {
            $modifiedColumns[':p' . $index++]  = 'default_calendar_view';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_INCLUDE_IN_PROVIDER_LIST)) {
            $modifiedColumns[':p' . $index++]  = 'include_in_provider_list';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_OTHER_PROFILES)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_other_profiles';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_OTHER_PROFILES)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_other_profiles';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_DELETE_SERVICES)) {
            $modifiedColumns[':p' . $index++]  = 'can_delete_services';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SERVICES)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_services';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADD_SCHEDULE)) {
            $modifiedColumns[':p' . $index++]  = 'can_add_schedule';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_GUEST)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_guest';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_CALENDAR)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_calendar';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_PROVIDERS)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_providers';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_SERVICES)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_services';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_FACILITIES)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_facilities';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_ACTIVITIES)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_activities';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_PACKAGES)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_packages';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_REPORTS)) {
            $modifiedColumns[':p' . $index++]  = 'can_admin_reports';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_LOCATION)) {
            $modifiedColumns[':p' . $index++]  = 'location';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_FORMS)) {
            $modifiedColumns[':p' . $index++]  = 'forms';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_1)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_1';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_1)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_1';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_2)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_2';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_2)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_2';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_3)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_3';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_3)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_3';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_INCLUDE_IN_AUDIT_LIST)) {
            $modifiedColumns[':p' . $index++]  = 'include_in_audit_list';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_COMPLETED_FORMS)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_completed_forms';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ASSIGN_SCHEDULES)) {
            $modifiedColumns[':p' . $index++]  = 'can_assign_schedules';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_OTHER_SCHEDULE)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_other_schedule';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_4)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_4';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_4)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_4';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_5)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_5';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_5)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_5';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_6)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_6';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_6)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_6';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_7)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_schedules_7';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_7)) {
            $modifiedColumns[':p' . $index++]  = 'can_edit_schedules_7';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_DASHBOARD)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_dashboard';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_NOTIFY_ON_BOOKINGS)) {
            $modifiedColumns[':p' . $index++]  = 'notify_on_bookings';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS)) {
            $modifiedColumns[':p' . $index++]  = 'can_manage_guest_bookings';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_FORMS)) {
            $modifiedColumns[':p' . $index++]  = 'can_manage_guest_forms';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_FINANCIAL)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_financial';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_TODAY_BOOKINGS)) {
            $modifiedColumns[':p' . $index++]  = 'can_view_today_bookings';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_TOP)) {
            $modifiedColumns[':p' . $index++]  = 'dashboard_top';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_MIDDLE)) {
            $modifiedColumns[':p' . $index++]  = 'dashboard_middle';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_BOTTOM)) {
            $modifiedColumns[':p' . $index++]  = 'dashboard_bottom';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CALENDAR_HEADER_RIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'calendar_header_right';
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_SETTINGS)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Groups
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Groups The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupsTableMap::COL_GROUP_CD)) {
            $criteria->add(GroupsTableMap::COL_GROUP_CD, $this->group_cd);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_GROUP_NAME)) {
            $criteria->add(GroupsTableMap::COL_GROUP_NAME, $this->group_name);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DEFAULT_CALENDAR_VIEW)) {
            $criteria->add(GroupsTableMap::COL_DEFAULT_CALENDAR_VIEW, $this->default_calendar_view);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_INCLUDE_IN_PROVIDER_LIST)) {
            $criteria->add(GroupsTableMap::COL_INCLUDE_IN_PROVIDER_LIST, $this->include_in_provider_list);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_OTHER_PROFILES)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_OTHER_PROFILES, $this->can_view_other_profiles);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_OTHER_PROFILES)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_OTHER_PROFILES, $this->can_edit_other_profiles);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_DELETE_SERVICES)) {
            $criteria->add(GroupsTableMap::COL_CAN_DELETE_SERVICES, $this->can_delete_services);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SERVICES)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SERVICES, $this->can_edit_services);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADD_SCHEDULE)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADD_SCHEDULE, $this->can_add_schedule);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_GUEST)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_GUEST, $this->can_admin_guest);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_CALENDAR)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_CALENDAR, $this->can_admin_calendar);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_PROVIDERS)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_PROVIDERS, $this->can_admin_providers);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_SERVICES)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_SERVICES, $this->can_admin_services);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_FACILITIES)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_FACILITIES, $this->can_admin_facilities);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_ACTIVITIES)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_ACTIVITIES, $this->can_admin_activities);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_PACKAGES)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_PACKAGES, $this->can_admin_packages);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ADMIN_REPORTS)) {
            $criteria->add(GroupsTableMap::COL_CAN_ADMIN_REPORTS, $this->can_admin_reports);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_LOCATION)) {
            $criteria->add(GroupsTableMap::COL_LOCATION, $this->location);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_FORMS)) {
            $criteria->add(GroupsTableMap::COL_FORMS, $this->forms);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_1)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_1, $this->can_view_schedules_1);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_1)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_1, $this->can_edit_schedules_1);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_2)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_2, $this->can_view_schedules_2);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_2)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_2, $this->can_edit_schedules_2);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_3)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_3, $this->can_view_schedules_3);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_3)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_3, $this->can_edit_schedules_3);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_INCLUDE_IN_AUDIT_LIST)) {
            $criteria->add(GroupsTableMap::COL_INCLUDE_IN_AUDIT_LIST, $this->include_in_audit_list);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_COMPLETED_FORMS)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_COMPLETED_FORMS, $this->can_edit_completed_forms);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_ASSIGN_SCHEDULES)) {
            $criteria->add(GroupsTableMap::COL_CAN_ASSIGN_SCHEDULES, $this->can_assign_schedules);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_OTHER_SCHEDULE)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_OTHER_SCHEDULE, $this->can_view_other_schedule);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_4)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_4, $this->can_view_schedules_4);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_4)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_4, $this->can_edit_schedules_4);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_5)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_5, $this->can_view_schedules_5);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_5)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_5, $this->can_edit_schedules_5);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_6)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_6, $this->can_view_schedules_6);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_6)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_6, $this->can_edit_schedules_6);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_7)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_SCHEDULES_7, $this->can_view_schedules_7);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_7)) {
            $criteria->add(GroupsTableMap::COL_CAN_EDIT_SCHEDULES_7, $this->can_edit_schedules_7);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_DASHBOARD)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_DASHBOARD, $this->can_view_dashboard);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_NOTIFY_ON_BOOKINGS)) {
            $criteria->add(GroupsTableMap::COL_NOTIFY_ON_BOOKINGS, $this->notify_on_bookings);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS)) {
            $criteria->add(GroupsTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS, $this->can_manage_guest_bookings);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_FORMS)) {
            $criteria->add(GroupsTableMap::COL_CAN_MANAGE_GUEST_FORMS, $this->can_manage_guest_forms);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_FINANCIAL)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_FINANCIAL, $this->can_view_financial);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_VIEW_TODAY_BOOKINGS)) {
            $criteria->add(GroupsTableMap::COL_CAN_VIEW_TODAY_BOOKINGS, $this->can_view_today_bookings);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_TOP)) {
            $criteria->add(GroupsTableMap::COL_DASHBOARD_TOP, $this->dashboard_top);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_MIDDLE)) {
            $criteria->add(GroupsTableMap::COL_DASHBOARD_MIDDLE, $this->dashboard_middle);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_DASHBOARD_BOTTOM)) {
            $criteria->add(GroupsTableMap::COL_DASHBOARD_BOTTOM, $this->dashboard_bottom);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CALENDAR_HEADER_RIGHT)) {
            $criteria->add(GroupsTableMap::COL_CALENDAR_HEADER_RIGHT, $this->calendar_header_right);
        }
        if ($this->isColumnModified(GroupsTableMap::COL_CAN_MANAGE_GUEST_SETTINGS)) {
            $criteria->add(GroupsTableMap::COL_CAN_MANAGE_GUEST_SETTINGS, $this->can_manage_guest_settings);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Groups (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Groups Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|ChildUsers[] List of ChildUsers objects
     */
    public function getUserssJoinLocations(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUsersQuery::create(null, $criteria);
