					...
					<section class="scrollable bg-white">
						<div class="content">
							...
							<div class="windowSettings js opened" style="display: none; position: absolute">
								...
								<h3>Position</h3>
								<div class="selectCont">
									<?php echo form_multiselect('positions', $positions, get_current_user_data('CalendarViewPositions'), 'id="calendar-position" class="selectpicker show-tick form-control"');?>
								</div>
								
								<h3>Department</h3>
								<div class="selectCont">
									<?php echo form_multiselect('locations[]', $locations, get_current_user_data('CalendarViewLocations'), 'id="calendar-location" class="selectpicker show-tick form-control"');?>
								</div>
