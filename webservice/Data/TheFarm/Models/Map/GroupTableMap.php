...
use TheFarm\Models\Group;
use TheFarm\Models\GroupQuery;
...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.GroupTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Group';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_GROUP_ID, GroupTableMap::COL_GROUP_CD, GroupTableMap::COL_GROUP_NAME, GroupTableMap::COL_DEFAULT_CALENDAR_VIEW, GroupTableMap::COL_INCLUDE_IN_PROVIDER_LIST, GroupTableMap::COL_CAN_VIEW_OTHER_PROFILES, GroupTableMap::COL_CAN_EDIT_OTHER_PROFILES, GroupTableMap::COL_CAN_DELETE_SERVICES, GroupTableMap::COL_CAN_EDIT_SERVICES, GroupTableMap::COL_CAN_ADD_SCHEDULE, GroupTableMap::COL_CAN_ADMIN_GUEST, GroupTableMap::COL_CAN_ADMIN_CALENDAR, GroupTableMap::COL_CAN_ADMIN_PROVIDERS, GroupTableMap::COL_CAN_ADMIN_SERVICES, GroupTableMap::COL_CAN_ADMIN_FACILITIES, GroupTableMap::COL_CAN_ADMIN_ACTIVITIES, GroupTableMap::COL_CAN_ADMIN_PACKAGES, GroupTableMap::COL_CAN_ADMIN_REPORTS, GroupTableMap::COL_LOCATION, GroupTableMap::COL_FORMS, GroupTableMap::COL_CAN_VIEW_SCHEDULES_1, GroupTableMap::COL_CAN_EDIT_SCHEDULES_1, GroupTableMap::COL_CAN_VIEW_SCHEDULES_2, GroupTableMap::COL_CAN_EDIT_SCHEDULES_2, GroupTableMap::COL_CAN_VIEW_SCHEDULES_3, GroupTableMap::COL_CAN_EDIT_SCHEDULES_3, GroupTableMap::COL_INCLUDE_IN_AUDIT_LIST, GroupTableMap::COL_CAN_EDIT_COMPLETED_FORMS, GroupTableMap::COL_CAN_ASSIGN_SCHEDULES, GroupTableMap::COL_CAN_VIEW_OTHER_SCHEDULE, GroupTableMap::COL_CAN_VIEW_SCHEDULES_4, GroupTableMap::COL_CAN_EDIT_SCHEDULES_4, GroupTableMap::COL_CAN_VIEW_SCHEDULES_5, GroupTableMap::COL_CAN_EDIT_SCHEDULES_5, GroupTableMap::COL_CAN_VIEW_SCHEDULES_6, GroupTableMap::COL_CAN_EDIT_SCHEDULES_6, GroupTableMap::COL_CAN_VIEW_SCHEDULES_7, GroupTableMap::COL_CAN_EDIT_SCHEDULES_7, GroupTableMap::COL_CAN_VIEW_DASHBOARD, GroupTableMap::COL_NOTIFY_ON_BOOKINGS, GroupTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS, GroupTableMap::COL_CAN_MANAGE_GUEST_FORMS, GroupTableMap::COL_CAN_VIEW_FINANCIAL, GroupTableMap::COL_CAN_VIEW_TODAY_BOOKINGS, GroupTableMap::COL_DASHBOARD_TOP, GroupTableMap::COL_DASHBOARD_MIDDLE, GroupTableMap::COL_DASHBOARD_BOTTOM, GroupTableMap::COL_CALENDAR_HEADER_RIGHT, GroupTableMap::COL_CAN_MANAGE_GUEST_SETTINGS, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_GROUP_ID => 0, GroupTableMap::COL_GROUP_CD => 1, GroupTableMap::COL_GROUP_NAME => 2, GroupTableMap::COL_DEFAULT_CALENDAR_VIEW => 3, GroupTableMap::COL_INCLUDE_IN_PROVIDER_LIST => 4, GroupTableMap::COL_CAN_VIEW_OTHER_PROFILES => 5, GroupTableMap::COL_CAN_EDIT_OTHER_PROFILES => 6, GroupTableMap::COL_CAN_DELETE_SERVICES => 7, GroupTableMap::COL_CAN_EDIT_SERVICES => 8, GroupTableMap::COL_CAN_ADD_SCHEDULE => 9, GroupTableMap::COL_CAN_ADMIN_GUEST => 10, GroupTableMap::COL_CAN_ADMIN_CALENDAR => 11, GroupTableMap::COL_CAN_ADMIN_PROVIDERS => 12, GroupTableMap::COL_CAN_ADMIN_SERVICES => 13, GroupTableMap::COL_CAN_ADMIN_FACILITIES => 14, GroupTableMap::COL_CAN_ADMIN_ACTIVITIES => 15, GroupTableMap::COL_CAN_ADMIN_PACKAGES => 16, GroupTableMap::COL_CAN_ADMIN_REPORTS => 17, GroupTableMap::COL_LOCATION => 18, GroupTableMap::COL_FORMS => 19, GroupTableMap::COL_CAN_VIEW_SCHEDULES_1 => 20, GroupTableMap::COL_CAN_EDIT_SCHEDULES_1 => 21, GroupTableMap::COL_CAN_VIEW_SCHEDULES_2 => 22, GroupTableMap::COL_CAN_EDIT_SCHEDULES_2 => 23, GroupTableMap::COL_CAN_VIEW_SCHEDULES_3 => 24, GroupTableMap::COL_CAN_EDIT_SCHEDULES_3 => 25, GroupTableMap::COL_INCLUDE_IN_AUDIT_LIST => 26, GroupTableMap::COL_CAN_EDIT_COMPLETED_FORMS => 27, GroupTableMap::COL_CAN_ASSIGN_SCHEDULES => 28, GroupTableMap::COL_CAN_VIEW_OTHER_SCHEDULE => 29, GroupTableMap::COL_CAN_VIEW_SCHEDULES_4 => 30, GroupTableMap::COL_CAN_EDIT_SCHEDULES_4 => 31, GroupTableMap::COL_CAN_VIEW_SCHEDULES_5 => 32, GroupTableMap::COL_CAN_EDIT_SCHEDULES_5 => 33, GroupTableMap::COL_CAN_VIEW_SCHEDULES_6 => 34, GroupTableMap::COL_CAN_EDIT_SCHEDULES_6 => 35, GroupTableMap::COL_CAN_VIEW_SCHEDULES_7 => 36, GroupTableMap::COL_CAN_EDIT_SCHEDULES_7 => 37, GroupTableMap::COL_CAN_VIEW_DASHBOARD => 38, GroupTableMap::COL_NOTIFY_ON_BOOKINGS => 39, GroupTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS => 40, GroupTableMap::COL_CAN_MANAGE_GUEST_FORMS => 41, GroupTableMap::COL_CAN_VIEW_FINANCIAL => 42, GroupTableMap::COL_CAN_VIEW_TODAY_BOOKINGS => 43, GroupTableMap::COL_DASHBOARD_TOP => 44, GroupTableMap::COL_DASHBOARD_MIDDLE => 45, GroupTableMap::COL_DASHBOARD_BOTTOM => 46, GroupTableMap::COL_CALENDAR_HEADER_RIGHT => 47, GroupTableMap::COL_CAN_MANAGE_GUEST_SETTINGS => 48, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Group');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GroupTableMap::COL_GROUP_ID);
            $criteria->addSelectColumn(GroupTableMap::COL_GROUP_CD);
            $criteria->addSelectColumn(GroupTableMap::COL_GROUP_NAME);
            $criteria->addSelectColumn(GroupTableMap::COL_DEFAULT_CALENDAR_VIEW);
            $criteria->addSelectColumn(GroupTableMap::COL_INCLUDE_IN_PROVIDER_LIST);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_OTHER_PROFILES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_OTHER_PROFILES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_DELETE_SERVICES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SERVICES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADD_SCHEDULE);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_GUEST);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_CALENDAR);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_PROVIDERS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_SERVICES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_FACILITIES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_ACTIVITIES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_PACKAGES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ADMIN_REPORTS);
            $criteria->addSelectColumn(GroupTableMap::COL_LOCATION);
            $criteria->addSelectColumn(GroupTableMap::COL_FORMS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_1);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_1);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_2);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_2);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_3);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_3);
            $criteria->addSelectColumn(GroupTableMap::COL_INCLUDE_IN_AUDIT_LIST);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_COMPLETED_FORMS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_ASSIGN_SCHEDULES);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_OTHER_SCHEDULE);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_4);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_4);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_5);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_5);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_6);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_6);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_SCHEDULES_7);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_EDIT_SCHEDULES_7);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_DASHBOARD);
            $criteria->addSelectColumn(GroupTableMap::COL_NOTIFY_ON_BOOKINGS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_MANAGE_GUEST_BOOKINGS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_MANAGE_GUEST_FORMS);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_FINANCIAL);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_VIEW_TODAY_BOOKINGS);
            $criteria->addSelectColumn(GroupTableMap::COL_DASHBOARD_TOP);
            $criteria->addSelectColumn(GroupTableMap::COL_DASHBOARD_MIDDLE);
            $criteria->addSelectColumn(GroupTableMap::COL_DASHBOARD_BOTTOM);
            $criteria->addSelectColumn(GroupTableMap::COL_CALENDAR_HEADER_RIGHT);
            $criteria->addSelectColumn(GroupTableMap::COL_CAN_MANAGE_GUEST_SETTINGS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Group) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(GroupTableMap::DATABASE_NAME);
            $criteria->add(GroupTableMap::COL_GROUP_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(GroupTableMap::COL_GROUP_ID) && $criteria->keyContainsValue(GroupTableMap::COL_GROUP_ID) ) {
