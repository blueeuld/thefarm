...
use TheFarm\Models\File;
use TheFarm\Models\FileQuery;
...
class FileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.FileTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\File';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.File';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FileTableMap::COL_FILE_ID, FileTableMap::COL_TITLE, FileTableMap::COL_FILE_NAME, FileTableMap::COL_FILE_SIZE, FileTableMap::COL_UPLOAD_ID, FileTableMap::COL_UPLOAD_DATE, FileTableMap::COL_LOCATION_ID, FileTableMap::COL_LAST_VIEWED, FileTableMap::COL_VIEWED_BY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FileTableMap::COL_FILE_ID => 0, FileTableMap::COL_TITLE => 1, FileTableMap::COL_FILE_NAME => 2, FileTableMap::COL_FILE_SIZE => 3, FileTableMap::COL_UPLOAD_ID => 4, FileTableMap::COL_UPLOAD_DATE => 5, FileTableMap::COL_LOCATION_ID => 6, FileTableMap::COL_LAST_VIEWED => 7, FileTableMap::COL_VIEWED_BY => 8, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\File');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FileTableMap::COL_TITLE);
            $criteria->addSelectColumn(FileTableMap::COL_FILE_NAME);
            $criteria->addSelectColumn(FileTableMap::COL_FILE_SIZE);
            $criteria->addSelectColumn(FileTableMap::COL_UPLOAD_ID);
            $criteria->addSelectColumn(FileTableMap::COL_UPLOAD_DATE);
            $criteria->addSelectColumn(FileTableMap::COL_LOCATION_ID);
            $criteria->addSelectColumn(FileTableMap::COL_LAST_VIEWED);
            $criteria->addSelectColumn(FileTableMap::COL_VIEWED_BY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\File) { // it's a model object
