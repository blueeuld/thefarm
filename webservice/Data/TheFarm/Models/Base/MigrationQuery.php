...
use TheFarm\Models\Migration as ChildMigration;
use TheFarm\Models\MigrationQuery as ChildMigrationQuery;
use TheFarm\Models\Map\MigrationTableMap;

/**
 * Base class that represents a query for the 'tf_migrations' table.
 *
 *
 *
 * @method     ChildMigrationQuery orderByVersion($order = Criteria::ASC) Order by the version column
 *
 * @method     ChildMigrationQuery groupByVersion() Group by the version column
 *
 ...
 *
 * @method     ChildMigration findOne(ConnectionInterface $con = null) Return the first ChildMigration matching the query
 ...
 *
 * @method     ChildMigration findOneByVersion(string $version) Return the first ChildMigration filtered by the version column *
 ...
 *
 * @method     ChildMigration requireOneByVersion(string $version) Return the first ChildMigration filtered by the version column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildMigration[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildMigration objects based on current ModelCriteria
 * @method     ChildMigration[]|ObjectCollection findByVersion(string $version) Return ChildMigration objects filtered by the version column
...
abstract class MigrationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \TheFarm\Models\Base\MigrationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\TheFarm\\Models\\Migration', $modelAlias = null)
    {
    ...
    {
        throw new LogicException('The Migration object has no primary key');
    }
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildMigrationQuery The current query, for fluid interface
     */
    ...
    public function filterByVersion($version = null, $comparison = null)
    {
        if (is_array($version)) {
            ...
            if (isset($version['min'])) {
                $this->addUsingAlias(MigrationTableMap::COL_VERSION, $version['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($version['max'])) {
                $this->addUsingAlias(MigrationTableMap::COL_VERSION, $version['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MigrationTableMap::COL_VERSION, $version, $comparison);
    }
    ...
    {
        if ($migration) {
            throw new LogicException('Migration object has no primary key');
    ...
    /**
     * Deletes all rows from the tf_migrations table.
     *
