 ...
 *
 * @method     \TheFarm\Models\FileQuery|\TheFarm\Models\LocationQuery|\TheFarm\Models\CategoryQuery|\TheFarm\Models\ItemCategoryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    public function filterByFile($file, $comparison = null)
    {
        if ($file instanceof \TheFarm\Models\File) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_CAT_IMAGE, $file->getFileId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CategoryTableMap::COL_CAT_IMAGE, $file->toKeyValue('PrimaryKey', 'FileId'), $comparison);
        } else {
