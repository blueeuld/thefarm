...
abstract class File implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\FileTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\File object.
     */
     ...
     * @return $this|\TheFarm\Models\File The current object (for fluent API support)
     */
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[FileTableMap::COL_TITLE] = true;
        }
    ...
    public function setFileName($v)
    {
        ...
        if ($this->file_name !== $v) {
            $this->file_name = $v;
            $this->modifiedColumns[FileTableMap::COL_FILE_NAME] = true;
        }
    ...
    public function setUploadId($v)
    {
        ...
        if ($this->upload_id !== $v) {
            $this->upload_id = $v;
            $this->modifiedColumns[FileTableMap::COL_UPLOAD_ID] = true;
        }
    ...
    public function setUploadDate($v)
    {
        ...
        if ($this->upload_date !== $v) {
            $this->upload_date = $v;
            $this->modifiedColumns[FileTableMap::COL_UPLOAD_DATE] = true;
        }
    ...
    public function setLocationId($v)
    {
        ...
        if ($this->location_id !== $v) {
            $this->location_id = $v;
            $this->modifiedColumns[FileTableMap::COL_LOCATION_ID] = true;
        }
    ...
    public function setLastViewed($v)
    {
        ...
        if ($this->last_viewed !== $v) {
            $this->last_viewed = $v;
            $this->modifiedColumns[FileTableMap::COL_LAST_VIEWED] = true;
        }
    ...
    public function setViewedBy($v)
    {
        ...
        if ($this->viewed_by !== $v) {
            $this->viewed_by = $v;
            $this->modifiedColumns[FileTableMap::COL_VIEWED_BY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FileTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FileTableMap::translateFieldName('FileName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->file_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FileTableMap::translateFieldName('FileSize', TableMap::TYPE_PHPNAME, $indexType)];
            $this->file_size = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FileTableMap::translateFieldName('UploadId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upload_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FileTableMap::translateFieldName('UploadDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upload_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FileTableMap::translateFieldName('LocationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FileTableMap::translateFieldName('LastViewed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_viewed = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : FileTableMap::translateFieldName('ViewedBy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\File'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(FileTableMap::COL_FILE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'file_name';
        }
        if ($this->isColumnModified(FileTableMap::COL_FILE_SIZE)) {
            $modifiedColumns[':p' . $index++]  = 'file_size';
        }
        if ($this->isColumnModified(FileTableMap::COL_UPLOAD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'upload_id';
        }
        if ($this->isColumnModified(FileTableMap::COL_UPLOAD_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'upload_date';
        }
        if ($this->isColumnModified(FileTableMap::COL_LOCATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'location_id';
        }
        if ($this->isColumnModified(FileTableMap::COL_LAST_VIEWED)) {
            $modifiedColumns[':p' . $index++]  = 'last_viewed';
        }
        if ($this->isColumnModified(FileTableMap::COL_VIEWED_BY)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\File
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\File The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_TITLE)) {
            $criteria->add(FileTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(FileTableMap::COL_FILE_NAME)) {
            $criteria->add(FileTableMap::COL_FILE_NAME, $this->file_name);
        }
        if ($this->isColumnModified(FileTableMap::COL_FILE_SIZE)) {
            $criteria->add(FileTableMap::COL_FILE_SIZE, $this->file_size);
        }
        if ($this->isColumnModified(FileTableMap::COL_UPLOAD_ID)) {
            $criteria->add(FileTableMap::COL_UPLOAD_ID, $this->upload_id);
        }
        if ($this->isColumnModified(FileTableMap::COL_UPLOAD_DATE)) {
            $criteria->add(FileTableMap::COL_UPLOAD_DATE, $this->upload_date);
        }
        if ($this->isColumnModified(FileTableMap::COL_LOCATION_ID)) {
            $criteria->add(FileTableMap::COL_LOCATION_ID, $this->location_id);
        }
        if ($this->isColumnModified(FileTableMap::COL_LAST_VIEWED)) {
            $criteria->add(FileTableMap::COL_LAST_VIEWED, $this->last_viewed);
        }
        if ($this->isColumnModified(FileTableMap::COL_VIEWED_BY)) {
            $criteria->add(FileTableMap::COL_VIEWED_BY, $this->viewed_by);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\File (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\File Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBookingAttachments(Collection $bookingAttachments, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookingAttachmentsToDelete as $bookingAttachmentRemoved) {
            $bookingAttachmentRemoved->setFile(null);
        }
    ...
    protected function doAddBookingAttachment(ChildBookingAttachment $bookingAttachment)
    {
        ...
        $bookingAttachment->setFile($this);
    }
    ...
    public function removeBookingAttachment(ChildBookingAttachment $bookingAttachment)
    {
        if ($this->getBookingAttachments()->contains($bookingAttachment)) {
            ...
            $bookingAttachment->setFile(null);
        }
