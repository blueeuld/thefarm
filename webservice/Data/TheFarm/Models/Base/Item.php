...
abstract class Item implements ActiveRecordInterface
{
    ...
    {
        if ($this->aFile !== null && $this->item_image !== $this->aFile->getFileId()) {
            $this->aFile = null;
        }
    } // ensureConsistency
    ...
    {
        if ($this->aFile === null && ($this->item_image !== null)) {
            $this->aFile = ChildFileQuery::create()->findPk($this->item_image, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFile->addItems($this);
             */
        }
