...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[UserTableMap::COL_ORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ORDER)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ORDER)) {
            $criteria->add(UserTableMap::COL_ORDER, $this->order);
        }
        if ($this->isColumnModified(UserTableMap::COL_CALENDAR_VIEW_POSITIONS)) {
