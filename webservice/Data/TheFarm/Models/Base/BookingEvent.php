...
abstract class BookingEvent implements ActiveRecordInterface
{
    ...
    /**
     * Sets the value of the [incl] column.
    ...
    /**
     * Sets the value of the [not_incl] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->incl = (null !== $col) ? (boolean) $col : null;
            ...
            $this->not_incl = (null !== $col) ? (boolean) $col : null;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'not_incl_os_done_amount':
                        ...
                        break;
                    case 'incl':
                        $stmt->bindValue($identifier, (int) $this->incl, PDO::PARAM_INT);
                        break;
                    case 'not_incl':
                        $stmt->bindValue($identifier, (int) $this->not_incl, PDO::PARAM_INT);
                        break;
                    case 'foc':
