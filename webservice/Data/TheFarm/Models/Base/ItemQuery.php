 ...
 *
 * @method     ChildItemQuery leftJoinFile($relationAlias = null) Adds a LEFT JOIN clause to the query using the File relation
 * @method     ChildItemQuery rightJoinFile($relationAlias = null) Adds a RIGHT JOIN clause to the query using the File relation
 * @method     ChildItemQuery innerJoinFile($relationAlias = null) Adds a INNER JOIN clause to the query using the File relation
 *
 * @method     ChildItemQuery joinWithFile($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the File relation
 *
 * @method     ChildItemQuery leftJoinWithFile() Adds a LEFT JOIN clause and with to the query using the File relation
 * @method     ChildItemQuery rightJoinWithFile() Adds a RIGHT JOIN clause and with to the query using the File relation
 * @method     ChildItemQuery innerJoinWithFile() Adds a INNER JOIN clause and with to the query using the File relation
 *
 ...
 *
 * @method     \TheFarm\Models\FileQuery|\TheFarm\Models\BookingEventQuery|\TheFarm\Models\BookingItemQuery|\TheFarm\Models\BookingQuery|\TheFarm\Models\ItemCategoryQuery|\TheFarm\Models\PackageItemQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ItemQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \TheFarm\Models\File object
     *
     * @param \TheFarm\Models\File|ObjectCollection $file The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($file instanceof \TheFarm\Models\File) {
            return $this
                ->addUsingAlias(ItemTableMap::COL_ITEM_IMAGE, $file->getFileId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ItemTableMap::COL_ITEM_IMAGE, $file->toKeyValue('PrimaryKey', 'FileId'), $comparison);
        } else {
            throw new PropelException('filterByFile() only accepts arguments of type \TheFarm\Models\File or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \TheFarm\Models\FileQuery A secondary query class using the current class as primary query
     */
    public function useFileQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinFile($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'File', '\TheFarm\Models\FileQuery');
    }
