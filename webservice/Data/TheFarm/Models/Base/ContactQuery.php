 ...
 * @method     ChildContact findOneByIsActive(int $is_active) Return the first ChildContact filtered by the is_active column
 ...
 * @method     ChildContact requireOneByIsActive(int $is_active) Return the first ChildContact filtered by the is_active column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildContact[]|ObjectCollection findByIsActive(int $is_active) Return ChildContact objects filtered by the is_active column
    ...
    public function filterByIsActive($isActive = null, $comparison = null)
    {
        if (is_array($isActive)) {
            ...
            if (isset($isActive['min'])) {
                $this->addUsingAlias(ContactTableMap::COL_IS_ACTIVE, $isActive['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($isActive['max'])) {
                $this->addUsingAlias(ContactTableMap::COL_IS_ACTIVE, $isActive['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
