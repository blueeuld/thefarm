 ...
 *
 * @method     ChildBookingAttachmentQuery leftJoinFile($relationAlias = null) Adds a LEFT JOIN clause to the query using the File relation
 * @method     ChildBookingAttachmentQuery rightJoinFile($relationAlias = null) Adds a RIGHT JOIN clause to the query using the File relation
 * @method     ChildBookingAttachmentQuery innerJoinFile($relationAlias = null) Adds a INNER JOIN clause to the query using the File relation
 *
 * @method     ChildBookingAttachmentQuery joinWithFile($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the File relation
 *
 * @method     ChildBookingAttachmentQuery leftJoinWithFile() Adds a LEFT JOIN clause and with to the query using the File relation
 * @method     ChildBookingAttachmentQuery rightJoinWithFile() Adds a RIGHT JOIN clause and with to the query using the File relation
 * @method     ChildBookingAttachmentQuery innerJoinWithFile() Adds a INNER JOIN clause and with to the query using the File relation
 *
 * @method     \TheFarm\Models\BookingQuery|\TheFarm\Models\FileQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookingAttachmentQuery extends ModelCriteria
{
    ...
    public function filterByFile($file, $comparison = null)
    {
        if ($file instanceof \TheFarm\Models\File) {
            return $this
                ->addUsingAlias(BookingAttachmentTableMap::COL_FILE_ID, $file->getFileId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BookingAttachmentTableMap::COL_FILE_ID, $file->toKeyValue('PrimaryKey', 'FileId'), $comparison);
        } else {
