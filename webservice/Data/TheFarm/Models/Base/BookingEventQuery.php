 ...
 * @method     ChildBookingEventQuery orderByBookingItemId($order = Criteria::ASC) Order by the booking_item_id column
 ...
 * @method     ChildBookingEventQuery groupByBookingItemId() Group by the booking_item_id column
 ...
 * @method     ChildBookingEventQuery innerJoinBookingItem($relationAlias = null) Adds a INNER JOIN clause to the query using the BookingItem relation
 *
 * @method     ChildBookingEventQuery joinWithBookingItem($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookingItem relation
 *
 * @method     ChildBookingEventQuery leftJoinWithBookingItem() Adds a LEFT JOIN clause and with to the query using the BookingItem relation
 * @method     ChildBookingEventQuery rightJoinWithBookingItem() Adds a RIGHT JOIN clause and with to the query using the BookingItem relation
 * @method     ChildBookingEventQuery innerJoinWithBookingItem() Adds a INNER JOIN clause and with to the query using the BookingItem relation
 *
 ...
 *
 * @method     ChildBookingEventQuery leftJoinBookingEventUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the BookingEventUser relation
 * @method     ChildBookingEventQuery rightJoinBookingEventUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BookingEventUser relation
 * @method     ChildBookingEventQuery innerJoinBookingEventUser($relationAlias = null) Adds a INNER JOIN clause to the query using the BookingEventUser relation
 *
 * @method     ChildBookingEventQuery joinWithBookingEventUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookingEventUser relation
 *
 * @method     ChildBookingEventQuery leftJoinWithBookingEventUser() Adds a LEFT JOIN clause and with to the query using the BookingEventUser relation
 ...
 * @method     ChildBookingEvent findOneByBookingItemId(int $booking_item_id) Return the first ChildBookingEvent filtered by the booking_item_id column
 ...
 * @method     ChildBookingEvent findOneByIsKids(string $is_kids) Return the first ChildBookingEvent filtered by the is_kids column
 ...
 * @method     ChildBookingEvent findOneByIncl(boolean $incl) Return the first ChildBookingEvent filtered by the incl column
 * @method     ChildBookingEvent findOneByNotIncl(boolean $not_incl) Return the first ChildBookingEvent filtered by the not_incl column
 * @method     ChildBookingEvent findOneByFoc(boolean $foc) Return the first ChildBookingEvent filtered by the foc column *
 ...
 * @method     ChildBookingEvent requireOneByBookingItemId(int $booking_item_id) Return the first ChildBookingEvent filtered by the booking_item_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildBookingEvent requireOneByIsKids(string $is_kids) Return the first ChildBookingEvent filtered by the is_kids column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildBookingEvent requireOneByIncl(boolean $incl) Return the first ChildBookingEvent filtered by the incl column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookingEvent requireOneByNotIncl(boolean $not_incl) Return the first ChildBookingEvent filtered by the not_incl column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookingEvent requireOneByFoc(boolean $foc) Return the first ChildBookingEvent filtered by the foc column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildBookingEvent[]|ObjectCollection findByBookingItemId(int $booking_item_id) Return ChildBookingEvent objects filtered by the booking_item_id column
 ...
 * @method     ChildBookingEvent[]|ObjectCollection findByIsKids(string $is_kids) Return ChildBookingEvent objects filtered by the is_kids column
 ...
 * @method     ChildBookingEvent[]|ObjectCollection findByIncl(boolean $incl) Return ChildBookingEvent objects filtered by the incl column
 * @method     ChildBookingEvent[]|ObjectCollection findByNotIncl(boolean $not_incl) Return ChildBookingEvent objects filtered by the not_incl column
 * @method     ChildBookingEvent[]|ObjectCollection findByFoc(boolean $foc) Return ChildBookingEvent objects filtered by the foc column
...
abstract class BookingEventQuery extends ModelCriteria
{
    ...
    public function filterByBookingItemId($bookingItemId = null, $comparison = null)
    {
        if (is_array($bookingItemId)) {
            ...
            if (isset($bookingItemId['min'])) {
                $this->addUsingAlias(BookingEventTableMap::COL_BOOKING_ITEM_ID, $bookingItemId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($bookingItemId['max'])) {
                $this->addUsingAlias(BookingEventTableMap::COL_BOOKING_ITEM_ID, $bookingItemId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingEventTableMap::COL_BOOKING_ITEM_ID, $bookingItemId, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByIncl(true); // WHERE incl = true
     * $query->filterByIncl('yes'); // WHERE incl = true
     * </code>
     *
     * @param     boolean|string $incl The value to use as filter.
    ...
    {
        if (is_string($incl)) {
            $incl = in_array(strtolower($incl), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }
     ...
     * Example usage:
     * <code>
     * $query->filterByNotIncl(true); // WHERE not_incl = true
     * $query->filterByNotIncl('yes'); // WHERE not_incl = true
     * </code>
     *
     * @param     boolean|string $notIncl The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    {
        if (is_string($notIncl)) {
            $notIncl = in_array(strtolower($notIncl), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }
     ...
     *
     * @param \TheFarm\Models\BookingItem|ObjectCollection $bookingItem The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByBookingItem($bookingItem, $comparison = null)
    {
        if ($bookingItem instanceof \TheFarm\Models\BookingItem) {
            return $this
                ->addUsingAlias(BookingEventTableMap::COL_BOOKING_ITEM_ID, $bookingItem->getBookingItemId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BookingEventTableMap::COL_BOOKING_ITEM_ID, $bookingItem->toKeyValue('PrimaryKey', 'BookingItemId'), $comparison);
        } else {
     ...
     * @return $this|ChildBookingEventQuery The current query, for fluid interface
     */
    public function joinBookingItem($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useBookingItemQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
    ...
    public function filterByBookingEventUser($bookingEventUser, $comparison = null)
    {
        if ($bookingEventUser instanceof \TheFarm\Models\BookingEventUser) {
            return $this
                ->addUsingAlias(BookingEventTableMap::COL_EVENT_ID, $bookingEventUser->getEventId(), $comparison);
