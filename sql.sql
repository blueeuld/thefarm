...
ALTER TABLE tf_booking_events ADD COLUMN incl_os_done_amount DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
ALTER TABLE tf_booking_events ADD COLUMN foc_os_done_number VARCHAR(20) NULL;
ALTER TABLE tf_booking_events ADD COLUMN foc_os_done_amount DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
ALTER TABLE tf_booking_events ADD COLUMN not_incl_os_done_number VARCHAR(20) NULL;
ALTER TABLE tf_booking_events ADD COLUMN not_incl_os_done_amount DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
