...
/**
 * Base class that represents a row from the 'tf_event' table.
 *
 *
 *
...
abstract class Event implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\EventTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Event object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\TheFarm\Models\Event The current object (for fluent API support)
     */
    ...
    public function setBookingId($v)
    {
        ...
        if ($this->booking_id !== $v) {
            $this->booking_id = $v;
            $this->modifiedColumns[EventTableMap::COL_BOOKING_ID] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_dt !== null || $dt !== null) {
            if ($this->start_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->start_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EventTableMap::COL_START_DT] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_dt !== null || $dt !== null) {
            if ($this->end_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->end_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EventTableMap::COL_END_DT] = true;
            }
        } // if either are not null
    ...
    public function setFacilityId($v)
    {
        ...
        if ($this->facility_id !== $v) {
            $this->facility_id = $v;
            $this->modifiedColumns[EventTableMap::COL_FACILITY_ID] = true;
        }
    ...
    public function setAllDay($v)
    {
        ...
        if ($this->all_day !== $v) {
            $this->all_day = $v;
            $this->modifiedColumns[EventTableMap::COL_ALL_DAY] = true;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[EventTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function setEntryDate($v)
    {
        ...
        if ($this->entry_date !== $v) {
            $this->entry_date = $v;
            $this->modifiedColumns[EventTableMap::COL_ENTRY_DATE] = true;
        }
    ...
    public function setEditDate($v)
    {
        ...
        if ($this->edit_date !== $v) {
            $this->edit_date = $v;
            $this->modifiedColumns[EventTableMap::COL_EDIT_DATE] = true;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[EventTableMap::COL_NOTES] = true;
        }
    ...
    public function setCalledBy($v)
    {
        ...
        if ($this->called_by !== $v) {
            $this->called_by = $v;
            $this->modifiedColumns[EventTableMap::COL_CALLED_BY] = true;
        }
    ...
    public function setCancelledBy($v)
    {
        ...
        if ($this->cancelled_by !== $v) {
            $this->cancelled_by = $v;
            $this->modifiedColumns[EventTableMap::COL_CANCELLED_BY] = true;
        }
    ...
    public function setCancelledReason($v)
    {
        ...
        if ($this->cancelled_reason !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_CANCELLED_REASON] = true;
        }
    ...
    public function setDateCancelled($v)
    {
        ...
        if ($this->date_cancelled !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_DATE_CANCELLED] = true;
        }
    ...
    public function setPersonalized($v)
    {
        ...
        if ($this->personalized !== $v) {
            $this->personalized = $v;
            $this->modifiedColumns[EventTableMap::COL_PERSONALIZED] = true;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[EventTableMap::COL_IS_ACTIVE] = true;
        }
    ...
    public function setDeletedDate($v)
    {
        ...
        if ($this->deleted_date !== $v) {
            $this->deleted_date = $v;
            $this->modifiedColumns[EventTableMap::COL_DELETED_DATE] = true;
        }
    ...
    public function setDeletedBy($v)
    {
        ...
        if ($this->deleted_by !== $v) {
            $this->deleted_by = $v;
            $this->modifiedColumns[EventTableMap::COL_DELETED_BY] = true;
        }
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[EventTableMap::COL_ITEM_ID] = true;
        }
    ...
    public function setIsKids($v)
    {
        ...
        if ($this->is_kids !== $v) {
            $this->is_kids = $v;
            $this->modifiedColumns[EventTableMap::COL_IS_KIDS] = true;
        }
    ...
    public function setInclOsDoneNumber($v)
    {
        ...
        if ($this->incl_os_done_number !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_INCL_OS_DONE_NUMBER] = true;
        }
    ...
    public function setInclOsDoneAmount($v)
    {
        ...
        if ($this->incl_os_done_amount !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_INCL_OS_DONE_AMOUNT] = true;
        }
    ...
    public function setFocOsDoneNumber($v)
    {
        ...
        if ($this->foc_os_done_number !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_FOC_OS_DONE_NUMBER] = true;
        }
    ...
    public function setFocOsDoneAmount($v)
    {
        ...
        if ($this->foc_os_done_amount !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_FOC_OS_DONE_AMOUNT] = true;
        }
    ...
    public function setNotInclOsDoneNumber($v)
    {
        ...
        if ($this->not_incl_os_done_number !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_NOT_INCL_OS_DONE_NUMBER] = true;
        }
    ...
    public function setNotInclOsDoneAmount($v)
    {
        ...
        if ($this->not_incl_os_done_amount !== $v) {
            ...
            $this->modifiedColumns[EventTableMap::COL_NOT_INCL_OS_DONE_AMOUNT] = true;
        }
    ...
    public function setIncl($v)
    {
        ...
        if ($this->incl !== $v) {
            $this->incl = $v;
            $this->modifiedColumns[EventTableMap::COL_INCL] = true;
        }
    ...
    public function setNotIncl($v)
    {
        ...
        if ($this->not_incl !== $v) {
            $this->not_incl = $v;
            $this->modifiedColumns[EventTableMap::COL_NOT_INCL] = true;
        }
    ...
    public function setFoc($v)
    {
        ...
        if ($this->foc !== $v) {
            $this->foc = $v;
            $this->modifiedColumns[EventTableMap::COL_FOC] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventTableMap::translateFieldName('BookingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->booking_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventTableMap::translateFieldName('EventTitle', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EventTableMap::translateFieldName('FacilityId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->facility_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EventTableMap::translateFieldName('AllDay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->all_day = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EventTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EventTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->author_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : EventTableMap::translateFieldName('EntryDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entry_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : EventTableMap::translateFieldName('EditDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->edit_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : EventTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : EventTableMap::translateFieldName('CalledBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->called_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : EventTableMap::translateFieldName('CancelledBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancelled_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : EventTableMap::translateFieldName('CancelledReason', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancelled_reason = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : EventTableMap::translateFieldName('DateCancelled', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_cancelled = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : EventTableMap::translateFieldName('Personalized', TableMap::TYPE_PHPNAME, $indexType)];
            $this->personalized = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : EventTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : EventTableMap::translateFieldName('DeletedDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deleted_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : EventTableMap::translateFieldName('DeletedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deleted_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : EventTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : EventTableMap::translateFieldName('IsKids', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_kids = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : EventTableMap::translateFieldName('InclOsDoneNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->incl_os_done_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : EventTableMap::translateFieldName('InclOsDoneAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->incl_os_done_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : EventTableMap::translateFieldName('FocOsDoneNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->foc_os_done_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : EventTableMap::translateFieldName('FocOsDoneAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->foc_os_done_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : EventTableMap::translateFieldName('NotInclOsDoneNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->not_incl_os_done_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : EventTableMap::translateFieldName('NotInclOsDoneAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->not_incl_os_done_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : EventTableMap::translateFieldName('Incl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->incl = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : EventTableMap::translateFieldName('NotIncl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->not_incl = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : EventTableMap::translateFieldName('Foc', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 31; // 31 = EventTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Event'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EventTableMap::COL_BOOKING_ID)) {
        ...
        if ($this->isColumnModified(EventTableMap::COL_START_DT)) {
            $modifiedColumns[':p' . $index++]  = 'start_dt';
        }
        if ($this->isColumnModified(EventTableMap::COL_END_DT)) {
            $modifiedColumns[':p' . $index++]  = 'end_dt';
        }
        if ($this->isColumnModified(EventTableMap::COL_FACILITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'facility_id';
        }
        if ($this->isColumnModified(EventTableMap::COL_ALL_DAY)) {
            $modifiedColumns[':p' . $index++]  = 'all_day';
        }
        if ($this->isColumnModified(EventTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(EventTableMap::COL_AUTHOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'author_id';
        }
        if ($this->isColumnModified(EventTableMap::COL_ENTRY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'entry_date';
        }
        if ($this->isColumnModified(EventTableMap::COL_EDIT_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'edit_date';
        }
        if ($this->isColumnModified(EventTableMap::COL_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'notes';
        }
        if ($this->isColumnModified(EventTableMap::COL_CALLED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'called_by';
        }
        if ($this->isColumnModified(EventTableMap::COL_CANCELLED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'cancelled_by';
        }
        if ($this->isColumnModified(EventTableMap::COL_CANCELLED_REASON)) {
            $modifiedColumns[':p' . $index++]  = 'cancelled_reason';
        }
        if ($this->isColumnModified(EventTableMap::COL_DATE_CANCELLED)) {
            $modifiedColumns[':p' . $index++]  = 'date_cancelled';
        }
        if ($this->isColumnModified(EventTableMap::COL_PERSONALIZED)) {
            $modifiedColumns[':p' . $index++]  = 'personalized';
        }
        if ($this->isColumnModified(EventTableMap::COL_IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'is_active';
        }
        if ($this->isColumnModified(EventTableMap::COL_DELETED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_date';
        }
        if ($this->isColumnModified(EventTableMap::COL_DELETED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_by';
        }
        if ($this->isColumnModified(EventTableMap::COL_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'item_id';
        }
        if ($this->isColumnModified(EventTableMap::COL_IS_KIDS)) {
            $modifiedColumns[':p' . $index++]  = 'is_kids';
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL_OS_DONE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'incl_os_done_number';
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL_OS_DONE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'incl_os_done_amount';
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC_OS_DONE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'foc_os_done_number';
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC_OS_DONE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'foc_os_done_amount';
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL_OS_DONE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'not_incl_os_done_number';
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL_OS_DONE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'not_incl_os_done_amount';
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL)) {
            $modifiedColumns[':p' . $index++]  = 'incl';
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL)) {
            $modifiedColumns[':p' . $index++]  = 'not_incl';
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC)) {
            $modifiedColumns[':p' . $index++]  = 'foc';
        }

        $sql = sprintf(
            'INSERT INTO tf_event (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Event
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Event The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventTableMap::COL_BOOKING_ID)) {
            $criteria->add(EventTableMap::COL_BOOKING_ID, $this->booking_id);
        }
        if ($this->isColumnModified(EventTableMap::COL_EVENT_TITLE)) {
            $criteria->add(EventTableMap::COL_EVENT_TITLE, $this->event_title);
        }
        if ($this->isColumnModified(EventTableMap::COL_START_DT)) {
            $criteria->add(EventTableMap::COL_START_DT, $this->start_dt);
        }
        if ($this->isColumnModified(EventTableMap::COL_END_DT)) {
            $criteria->add(EventTableMap::COL_END_DT, $this->end_dt);
        }
        if ($this->isColumnModified(EventTableMap::COL_FACILITY_ID)) {
            $criteria->add(EventTableMap::COL_FACILITY_ID, $this->facility_id);
        }
        if ($this->isColumnModified(EventTableMap::COL_ALL_DAY)) {
            $criteria->add(EventTableMap::COL_ALL_DAY, $this->all_day);
        }
        if ($this->isColumnModified(EventTableMap::COL_STATUS)) {
            $criteria->add(EventTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(EventTableMap::COL_AUTHOR_ID)) {
            $criteria->add(EventTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(EventTableMap::COL_ENTRY_DATE)) {
            $criteria->add(EventTableMap::COL_ENTRY_DATE, $this->entry_date);
        }
        if ($this->isColumnModified(EventTableMap::COL_EDIT_DATE)) {
            $criteria->add(EventTableMap::COL_EDIT_DATE, $this->edit_date);
        }
        if ($this->isColumnModified(EventTableMap::COL_NOTES)) {
            $criteria->add(EventTableMap::COL_NOTES, $this->notes);
        }
        if ($this->isColumnModified(EventTableMap::COL_CALLED_BY)) {
            $criteria->add(EventTableMap::COL_CALLED_BY, $this->called_by);
        }
        if ($this->isColumnModified(EventTableMap::COL_CANCELLED_BY)) {
            $criteria->add(EventTableMap::COL_CANCELLED_BY, $this->cancelled_by);
        }
        if ($this->isColumnModified(EventTableMap::COL_CANCELLED_REASON)) {
            $criteria->add(EventTableMap::COL_CANCELLED_REASON, $this->cancelled_reason);
        }
        if ($this->isColumnModified(EventTableMap::COL_DATE_CANCELLED)) {
            $criteria->add(EventTableMap::COL_DATE_CANCELLED, $this->date_cancelled);
        }
        if ($this->isColumnModified(EventTableMap::COL_PERSONALIZED)) {
            $criteria->add(EventTableMap::COL_PERSONALIZED, $this->personalized);
        }
        if ($this->isColumnModified(EventTableMap::COL_IS_ACTIVE)) {
            $criteria->add(EventTableMap::COL_IS_ACTIVE, $this->is_active);
        }
        if ($this->isColumnModified(EventTableMap::COL_DELETED_DATE)) {
            $criteria->add(EventTableMap::COL_DELETED_DATE, $this->deleted_date);
        }
        if ($this->isColumnModified(EventTableMap::COL_DELETED_BY)) {
            $criteria->add(EventTableMap::COL_DELETED_BY, $this->deleted_by);
        }
        if ($this->isColumnModified(EventTableMap::COL_ITEM_ID)) {
            $criteria->add(EventTableMap::COL_ITEM_ID, $this->item_id);
        }
        if ($this->isColumnModified(EventTableMap::COL_IS_KIDS)) {
            $criteria->add(EventTableMap::COL_IS_KIDS, $this->is_kids);
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL_OS_DONE_NUMBER)) {
            $criteria->add(EventTableMap::COL_INCL_OS_DONE_NUMBER, $this->incl_os_done_number);
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL_OS_DONE_AMOUNT)) {
            $criteria->add(EventTableMap::COL_INCL_OS_DONE_AMOUNT, $this->incl_os_done_amount);
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC_OS_DONE_NUMBER)) {
            $criteria->add(EventTableMap::COL_FOC_OS_DONE_NUMBER, $this->foc_os_done_number);
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC_OS_DONE_AMOUNT)) {
            $criteria->add(EventTableMap::COL_FOC_OS_DONE_AMOUNT, $this->foc_os_done_amount);
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL_OS_DONE_NUMBER)) {
            $criteria->add(EventTableMap::COL_NOT_INCL_OS_DONE_NUMBER, $this->not_incl_os_done_number);
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL_OS_DONE_AMOUNT)) {
            $criteria->add(EventTableMap::COL_NOT_INCL_OS_DONE_AMOUNT, $this->not_incl_os_done_amount);
        }
        if ($this->isColumnModified(EventTableMap::COL_INCL)) {
            $criteria->add(EventTableMap::COL_INCL, $this->incl);
        }
        if ($this->isColumnModified(EventTableMap::COL_NOT_INCL)) {
            $criteria->add(EventTableMap::COL_NOT_INCL, $this->not_incl);
        }
        if ($this->isColumnModified(EventTableMap::COL_FOC)) {
            $criteria->add(EventTableMap::COL_FOC, $this->foc);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Event (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Event Clone of current object.
     * @throws PropelException
     */
    ...
    public function setUserRelatedByAuthorId(ChildUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEventRelatedByAuthorId($this);
        }
    ...
    public function getUserRelatedByAuthorId(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByAuthorId === null && ($this->author_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByAuthorId->addEventsRelatedByAuthorId($this);
             */
        }
    ...
    public function setUserRelatedByCalledBy(ChildUser $v = null)
    {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addEventRelatedByCalledBy($this);
        }
    ...
    public function getUserRelatedByCalledBy(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByCalledBy === null && ($this->called_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCalledBy->addEventsRelatedByCalledBy($this);
             */
        }
    ...
    public function setUserRelatedByCancelledBy(ChildUser $v = null)
    {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addEventRelatedByCancelledBy($this);
        }
    ...
    public function getUserRelatedByCancelledBy(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByCancelledBy === null && ($this->cancelled_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCancelledBy->addEventsRelatedByCancelledBy($this);
             */
        }
    ...
    public function setUserRelatedByDeletedBy(ChildUser $v = null)
    {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addEventRelatedByDeletedBy($this);
        }
    ...
    public function getUserRelatedByDeletedBy(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByDeletedBy === null && ($this->deleted_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByDeletedBy->addEventsRelatedByDeletedBy($this);
             */
        }
    ...
    public function getEventStatus(ConnectionInterface $con = null)
    {
        if ($this->aEventStatus === null && (($this->status !== "" && $this->status !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEventStatus->addEvents($this);
             */
        }
    ...
    {
        if (null !== $this->aUserRelatedByAuthorId) {
            $this->aUserRelatedByAuthorId->removeEventRelatedByAuthorId($this);
        }
        if (null !== $this->aBooking) {
            $this->aBooking->removeEvent($this);
        }
        if (null !== $this->aUserRelatedByCalledBy) {
            $this->aUserRelatedByCalledBy->removeEventRelatedByCalledBy($this);
        }
        if (null !== $this->aUserRelatedByCancelledBy) {
            $this->aUserRelatedByCancelledBy->removeEventRelatedByCancelledBy($this);
        }
        if (null !== $this->aUserRelatedByDeletedBy) {
            $this->aUserRelatedByDeletedBy->removeEventRelatedByDeletedBy($this);
        }
        if (null !== $this->aFacility) {
            $this->aFacility->removeEvent($this);
        }
        if (null !== $this->aItem) {
            $this->aItem->removeEvent($this);
        }
        if (null !== $this->aEventStatus) {
            $this->aEventStatus->removeEvent($this);
        }
        $this->event_id = null;
