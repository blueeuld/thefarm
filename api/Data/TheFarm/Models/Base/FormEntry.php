 ...
 */
abstract class FormEntry implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\FormEntryTableMap';
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\FormEntry object.
     */
    ...
    /**
     * Compares this with another <code>FormEntry</code> instance.  If
     * <code>obj</code> is an instance of <code>FormEntry</code>, delegates to
     * <code>equals(FormEntry)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|FormEntry The current object, for fluid interface
     */
    ...
    public function setEntryId($v)
    {
        ...
        if ($this->entry_id !== $v) {
            $this->entry_id = $v;
            $this->modifiedColumns[FormEntryTableMap::COL_ENTRY_ID] = true;
        }
    ...
    public function setBookingId($v)
    {
        ...
        if ($this->booking_id !== $v) {
            $this->booking_id = $v;
            $this->modifiedColumns[FormEntryTableMap::COL_BOOKING_ID] = true;
        }
    ...
    public function setFormId($v)
    {
        ...
        if ($this->form_id !== $v) {
            $this->form_id = $v;
            $this->modifiedColumns[FormEntryTableMap::COL_FORM_ID] = true;
        }
    ...
    public function setFieldId($v)
    {
        ...
        if ($this->field_id !== $v) {
            $this->field_id = $v;
            $this->modifiedColumns[FormEntryTableMap::COL_FIELD_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FormEntryTableMap::translateFieldName('EntryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entry_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FormEntryTableMap::translateFieldName('BookingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->booking_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FormEntryTableMap::translateFieldName('FormId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFormEntryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FormEntry::setDeleted()
     * @see FormEntry::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFormEntryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FormEntryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FormEntryTableMap::COL_ENTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'entry_id';
        }
        if ($this->isColumnModified(FormEntryTableMap::COL_BOOKING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'booking_id';
        }
        if ($this->isColumnModified(FormEntryTableMap::COL_FORM_ID)) {
    ...
    {
        $pos = FormEntryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['FormEntry'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FormEntry'][$this->hashCode()] = true;
        $keys = FormEntryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\FormEntry
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\FormEntry The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormEntryTableMap::COL_ENTRY_ID)) {
            $criteria->add(FormEntryTableMap::COL_ENTRY_ID, $this->entry_id);
        }
        if ($this->isColumnModified(FormEntryTableMap::COL_BOOKING_ID)) {
            $criteria->add(FormEntryTableMap::COL_BOOKING_ID, $this->booking_id);
        }
        if ($this->isColumnModified(FormEntryTableMap::COL_FORM_ID)) {
            $criteria->add(FormEntryTableMap::COL_FORM_ID, $this->form_id);
        }
        if ($this->isColumnModified(FormEntryTableMap::COL_FIELD_ID)) {
    ...
    {
        $criteria = ChildFormEntryQuery::create();
        $criteria->add(FormEntryTableMap::COL_ENTRY_ID, $this->entry_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\FormEntry (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\FormEntry Clone of current object.
     * @throws PropelException
     */
    ...
    public function getBooking(ConnectionInterface $con = null)
    {
        if ($this->aBooking === null && ($this->booking_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBooking->addFormEntries($this);
             */
        }
    ...
    public function getField(ConnectionInterface $con = null)
    {
        if ($this->aField === null && ($this->field_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aField->addFormEntries($this);
             */
        }
    ...
    public function getForm(ConnectionInterface $con = null)
    {
        if ($this->aForm === null && ($this->form_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aForm->addFormEntries($this);
             */
        }
    ...
    {
        if (null !== $this->aBooking) {
            $this->aBooking->removeFormEntry($this);
        }
        if (null !== $this->aField) {
            $this->aField->removeFormEntry($this);
        }
        if (null !== $this->aForm) {
            $this->aForm->removeFormEntry($this);
        }
        $this->entry_id = null;
    ...
    {
        return (string) $this->exportTo(FormEntryTableMap::DEFAULT_STRING_FORMAT);
    }
