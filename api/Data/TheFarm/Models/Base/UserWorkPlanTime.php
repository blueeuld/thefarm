 ...
 */
abstract class UserWorkPlanTime implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\UserWorkPlanTimeTableMap';
    ...
    /**
     * Compares this with another <code>UserWorkPlanTime</code> instance.  If
     * <code>obj</code> is an instance of <code>UserWorkPlanTime</code>, delegates to
     * <code>equals(UserWorkPlanTime)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserWorkPlanTime The current object, for fluid interface
     */
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->start_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserWorkPlanTimeTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($this->end_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->end_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserWorkPlanTimeTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserWorkPlanTimeTableMap::translateFieldName('ContactId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserWorkPlanTimeTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserWorkPlanTimeTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserWorkPlanTimeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserWorkPlanTime::setDeleted()
     * @see UserWorkPlanTime::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserWorkPlanTimeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserWorkPlanTimeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserWorkPlanTimeTableMap::COL_CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'contact_id';
        }
        if ($this->isColumnModified(UserWorkPlanTimeTableMap::COL_START_DATE)) {
    ...
    {
        $pos = UserWorkPlanTimeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['UserWorkPlanTime'][$this->hashCode()] = true;
        $keys = UserWorkPlanTimeTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\UserWorkPlanTime
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\UserWorkPlanTime The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\UserWorkPlanTime (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\UserWorkPlanTime Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UserWorkPlanTimeTableMap::DEFAULT_STRING_FORMAT);
    }
