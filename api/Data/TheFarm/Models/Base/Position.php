...
/**
 * Base class that represents a row from the 'tf_position' table.
 *
 *
 *
...
abstract class Position implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TheFarm\\Models\\Map\\PositionTableMap';
    ...
    /**
     * The value for the position_value field.
     *
     * @var        string
     */
    ...
    /**
     * The value for the position_order field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of TheFarm\Models\Base\Position object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [position_value] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [position_order] column value.
     *
     * @return int
     */
    ...
    public function setPositionCd($v)
    {
        ...
        if ($this->position_cd !== $v) {
            $this->position_cd = $v;
            $this->modifiedColumns[PositionTableMap::COL_POSITION_CD] = true;
        }
    ...
    /**
     * Set the value of [position_value] column.
     *
     * @param string $v new value
     * @return $this|\TheFarm\Models\Position The current object (for fluent API support)
     */
    public function setPositionValue($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->position_value !== $v) {
            $this->position_value = $v;
            $this->modifiedColumns[PositionTableMap::COL_POSITION_VALUE] = true;
        }
    ...
    /**
     * Set the value of [position_order] column.
     *
     * @param int $v new value
     * @return $this|\TheFarm\Models\Position The current object (for fluent API support)
     */
    public function setPositionOrder($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->position_order !== $v) {
            $this->position_order = $v;
            $this->modifiedColumns[PositionTableMap::COL_POSITION_ORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PositionTableMap::translateFieldName('PositionCd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position_cd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PositionTableMap::translateFieldName('PositionValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position_value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PositionTableMap::translateFieldName('PositionOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position_order = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = PositionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TheFarm\\Models\\Position'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_CD)) {
            $modifiedColumns[':p' . $index++]  = 'position_cd';
        }
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'position_value';
        }
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'position_order';
        }

        $sql = sprintf(
            'INSERT INTO tf_position (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'position_cd':
                        ...
                        break;
                    case 'position_value':
                        $stmt->bindValue($identifier, $this->position_value, PDO::PARAM_STR);
                        break;
                    case 'position_order':
                        $stmt->bindValue($identifier, $this->position_order, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getPositionCd(),
            $keys[1] => $this->getPositionValue(),
            $keys[2] => $this->getPositionOrder(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TheFarm\Models\Position
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setPositionValue($value);
                break;
            case 2:
                $this->setPositionOrder($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setPositionCd($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setPositionValue($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPositionOrder($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TheFarm\Models\Position The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_CD)) {
            $criteria->add(PositionTableMap::COL_POSITION_CD, $this->position_cd);
        }
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_VALUE)) {
            $criteria->add(PositionTableMap::COL_POSITION_VALUE, $this->position_value);
        }
        if ($this->isColumnModified(PositionTableMap::COL_POSITION_ORDER)) {
            $criteria->add(PositionTableMap::COL_POSITION_ORDER, $this->position_order);
        }
    ...
    {
        $validPk = null !== $this->getPositionCd();
    ...
    /**
     * Generic method to set the primary key (position_cd column).
     *
    ...
    {
        return null === $this->getPositionCd();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TheFarm\Models\Position (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPositionValue($this->getPositionValue());
        $copyObj->setPositionOrder($this->getPositionOrder());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TheFarm\Models\Position Clone of current object.
     * @throws PropelException
     */
