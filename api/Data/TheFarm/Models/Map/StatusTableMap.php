...
use TheFarm\Models\Status;
use TheFarm\Models\StatusQuery;
...
class StatusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.StatusTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Status';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Status';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StatusTableMap::COL_STATUS_ID, StatusTableMap::COL_GROUP_ID, StatusTableMap::COL_STATUS_CD, StatusTableMap::COL_STATUS_NAME, StatusTableMap::COL_STATUS_ORDER, StatusTableMap::COL_STATUS_STYLE, StatusTableMap::COL_INCLUDE_IN_SALES, StatusTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StatusTableMap::COL_STATUS_ID => 0, StatusTableMap::COL_GROUP_ID => 1, StatusTableMap::COL_STATUS_CD => 2, StatusTableMap::COL_STATUS_NAME => 3, StatusTableMap::COL_STATUS_ORDER => 4, StatusTableMap::COL_STATUS_STYLE => 5, StatusTableMap::COL_INCLUDE_IN_SALES => 6, StatusTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING => 7, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Status');
    ...
    {
        return $withPrefix ? StatusTableMap::CLASS_DEFAULT : StatusTableMap::OM_CLASS;
    }
    ...
    {
        $key = StatusTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = StatusTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + StatusTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = StatusTableMap::OM_CLASS;
            /** @var Status $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            StatusTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = StatusTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = StatusTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StatusTableMap::COL_STATUS_ID);
            $criteria->addSelectColumn(StatusTableMap::COL_GROUP_ID);
            $criteria->addSelectColumn(StatusTableMap::COL_STATUS_CD);
            $criteria->addSelectColumn(StatusTableMap::COL_STATUS_NAME);
            $criteria->addSelectColumn(StatusTableMap::COL_STATUS_ORDER);
            $criteria->addSelectColumn(StatusTableMap::COL_STATUS_STYLE);
            $criteria->addSelectColumn(StatusTableMap::COL_INCLUDE_IN_SALES);
            $criteria->addSelectColumn(StatusTableMap::COL_INCLUDE_IN_DUPLICATE_CHECKING);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(StatusTableMap::DATABASE_NAME)->getTable(StatusTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(StatusTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(StatusTableMap::TABLE_NAME)) {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Status) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(StatusTableMap::DATABASE_NAME);
            $criteria->add(StatusTableMap::COL_STATUS_ID, (array) $values, Criteria::IN);
        }

        $query = StatusQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            StatusTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                StatusTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return StatusQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a Status or Criteria object.
     *
     * @param mixed               $criteria Criteria or Status object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from Status object
        }

        if ($criteria->containsKey(StatusTableMap::COL_STATUS_ID) && $criteria->keyContainsValue(StatusTableMap::COL_STATUS_ID) ) {
