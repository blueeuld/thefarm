...
use TheFarm\Models\Message;
use TheFarm\Models\MessageQuery;
...
class MessageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TheFarm.Models.Map.MessageTableMap';
     ...
     */
    const OM_CLASS = '\\TheFarm\\Models\\Message';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TheFarm.Models.Message';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(MessageTableMap::COL_MESSAGE_ID, MessageTableMap::COL_MESSAGE, MessageTableMap::COL_SENDER, MessageTableMap::COL_RECEIVER, MessageTableMap::COL_DATE_SENT, MessageTableMap::COL_DATE_READ, MessageTableMap::COL_MESSAGE_TYPE, MessageTableMap::COL_RECEIVED, MessageTableMap::COL_RECEIVER_EMAIL, MessageTableMap::COL_SUBJECT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(MessageTableMap::COL_MESSAGE_ID => 0, MessageTableMap::COL_MESSAGE => 1, MessageTableMap::COL_SENDER => 2, MessageTableMap::COL_RECEIVER => 3, MessageTableMap::COL_DATE_SENT => 4, MessageTableMap::COL_DATE_READ => 5, MessageTableMap::COL_MESSAGE_TYPE => 6, MessageTableMap::COL_RECEIVED => 7, MessageTableMap::COL_RECEIVER_EMAIL => 8, MessageTableMap::COL_SUBJECT => 9, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TheFarm\\Models\\Message');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MessageTableMap::COL_MESSAGE_ID);
            $criteria->addSelectColumn(MessageTableMap::COL_MESSAGE);
            $criteria->addSelectColumn(MessageTableMap::COL_SENDER);
            $criteria->addSelectColumn(MessageTableMap::COL_RECEIVER);
            $criteria->addSelectColumn(MessageTableMap::COL_DATE_SENT);
            $criteria->addSelectColumn(MessageTableMap::COL_DATE_READ);
            $criteria->addSelectColumn(MessageTableMap::COL_MESSAGE_TYPE);
            $criteria->addSelectColumn(MessageTableMap::COL_RECEIVED);
            $criteria->addSelectColumn(MessageTableMap::COL_RECEIVER_EMAIL);
            $criteria->addSelectColumn(MessageTableMap::COL_SUBJECT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TheFarm\Models\Message) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(MessageTableMap::DATABASE_NAME);
            $criteria->add(MessageTableMap::COL_MESSAGE_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(MessageTableMap::COL_MESSAGE_ID) && $criteria->keyContainsValue(MessageTableMap::COL_MESSAGE_ID) ) {
