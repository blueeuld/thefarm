 ...
 * up to version 1504658199.
 * Generated on 2017-09-06 00:36:39 by marvin
 */
class PropelMigration_1504658199
{
    public $comment = '';
...
RENAME TABLE `tf_user_work_plan_code` TO `tf_work_plan`;
...
CREATE INDEX `tf_user_work_plan_time_fi_a9b2fd` ON `tf_user_work_plan_time` (`work_plan_cd`);

ALTER TABLE `tf_user_work_plan_time` ADD CONSTRAINT `tf_user_work_plan_time_fk_a9b2fd`
...
RENAME TABLE `tf_work_plan` TO `tf_user_work_plan_code`;
...
ALTER TABLE `tf_user_work_plan_time` DROP FOREIGN KEY `tf_user_work_plan_time_fk_a9b2fd`;

DROP INDEX `tf_user_work_plan_time_fi_a9b2fd` ON `tf_user_work_plan_time`;
